...
|:-----:|---------------------------------------------------|:-------------------:|:--------------------:|:-----------------:|:--------------------:|:---------------:|
|       |                                                   |                     |                      |                   | **№ серт.**          | **Дата выдачи** |
| 1     | Astra Linux 1.7 Special Edition Смоленск (x86-64) | +                   | +                    | 20.10.2           | 2557                 | 30.01.2012      |
| 2     | Astra Linux 1.8 (x86-64)                          | +                   | +                    | -                 | -                    | -               |
| 3     | Альт 8 СП                                         | +                   | +                    | 20.10.11          | 3866                 | 10.08.2018      |
| 4     | Альт 10 СП                                        | +                   | +                    | 20.10.11          | 3866                 | 10.08.2018      |
| 5     | ОСНОВА2                                           | +                   | +                    | 20.10.5           | 4381                 | 31.03.2021      |
| 6     | РЕД ОС 7.3 Муром                                  | +                   | +                    | 20.10.1           | 4060                 | 12.01.2019      |
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image3.png)

Рисунок . – Синхронизация пакетов
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image4.png)

Рисунок . – Обновление пакетов ОС
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image5.png)

Рисунок . - Установка платформы docker в ОС
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image6.png)

Рисунок . – Проверка версии установленной платформы docker
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image7.png)

Рисунок . – Выполнение команды chmod
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image8.png)

Рисунок . – Выполнение скрипта setup.sh
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image9.png)

Рисунок . – Вывод данных об образе
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image10.png)

Рисунок . – Проверки, которые контейнер делает после запуска
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image11.png)
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image12.png)

Рисунок . – Содержимое каталога

1.  Далее необходимо запустить контейнер и одновременно вывести журнал событий контейнера:

```
./run.sh; ./log.sh
```

![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image13.png)

Рисунок . – Журнал событий контейнера после запуска скриптов «./run.sh; ./log.sh»
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image14.png)

Рисунок . – Вывод статуса контейнера
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image15.png)

Рисунок . – Вывод команды проверки созданных томов
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image16.png)

Рисунок . – Команда остановки контейнера
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image17.png)

Рисунок . – Вывод статуса остановленного контейнера
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image18.png)

Рисунок . – Команда запуска контейнера
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image19.png)

Рисунок . – Выполнение команды перезапуска контейнера
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image20.png)

Рисунок . – Вывод скрипта логирования
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image21.png)

Рисунок . – Удаление контейнера
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image22.png)

Рисунок . – Команды удаления томов с данными и расширениями СУБД
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image23.png)
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/container/media/image24.png)

Рисунок . - Запуск утилиты psql в контейнере
