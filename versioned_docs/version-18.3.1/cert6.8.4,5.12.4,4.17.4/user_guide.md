...
<p>643.72410666.00067-07 96 01-ЛУ</p></th>
...
<p><strong>Руководство пользователя</strong></p></td>
</tr>
<tr>
<td colspan="2" style="text-align: center;"><strong>643.72410666.00067-07 96 01</strong></td>
</tr>
<tr>
...
<tr>
<td colspan="2" style="text-align: center;">Листов 151</td>
</tr>
<tr>
<td style="text-align: center;"></td>
<td style="text-align: center;"></td>
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image1.png" style="width:0.25139in;height:0.25139in" /> | **Важная информация** – указания, требующие особого внимания |
|:--:|----|
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | **Дополнительная информация** – указания, позволяющие упростить работу с изделием |
...
ОС Windows – «C:\Program Files\GIS\Jatoba\5\bin»;ОС Linux – «/usr/jatoba-5/bin».
...
<thead>
<tr>
<th style="text-align: center;"><img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image1.png" style="width:0.25139in;height:0.25139in" /></th>
...
[1. Общие сведения о СУБД «Jatoba» [7](#общие-сведения-о-субд-jatoba)](#общие-сведения-о-субд-jatoba)

[1.1. Назначение СУБД «Jatoba» [7](#назначение-субд-jatoba)](#назначение-субд-jatoba)

[1.2. Функции СУБД «Jatoba» [7](#функции-субд-jatoba)](#функции-субд-jatoba)

[1.3. Требования к среде функционирования СУБД «Jatoba» [8](#хранение-пространственных-географических-и-геометрических-данных-поддержка-запросов-к-ним-и-управление-имисинтаксическая-совместимость-с-распространенными-plsql-oracleрасширенные-возможности-секционирования-больших-таблицпротоколирование-анализ-и-контроль-выполнения-команд-манипулирования-данными-ddldmlсбор-журналов-аудита-всех-операций-и-загрузка-конфигураций-в-субдработа-в-составе-отказоустойчивого-кластера-с-механизмом-переключения-нагрузки-на-основной-узел-кластеразащита-от-несанкционированного-изменения-конфигурационных-файловединый-пользовательский-интерфейс-для-управления-конфигурациями-компонентов-и-просмотра-их-состояния-субд.требования-к-среде-функционирования-субд-jatoba)](#хранение-пространственных-географических-и-геометрических-данных-поддержка-запросов-к-ним-и-управление-имисинтаксическая-совместимость-с-распространенными-plsql-oracleрасширенные-возможности-секционирования-больших-таблицпротоколирование-анализ-и-контроль-выполнения-команд-манипулирования-данными-ddldmlсбор-журналов-аудита-всех-операций-и-загрузка-конфигураций-в-субдработа-в-составе-отказоустойчивого-кластера-с-механизмом-переключения-нагрузки-на-основной-узел-кластеразащита-от-несанкционированного-изменения-конфигурационных-файловединый-пользовательский-интерфейс-для-управления-конфигурациями-компонентов-и-просмотра-их-состояния-субд.требования-к-среде-функционирования-субд-jatoba)

[2. Порядок подключения к СУБД «Jatoba» [10](#порядок-подключения-к-субд-jatoba)](#порядок-подключения-к-субд-jatoba)

[3. Описание операций СУБД «Jatoba» [11](#описание-операций-субд-jatoba)](#описание-операций-субд-jatoba)

[4. Синтаксис SQL [12](#синтаксис-sql)](#синтаксис-sql)

[4.1. Лексическая структура [12](#лексическая-структура)](#лексическая-структура)

[4.1.1. Идентификаторы и ключевые слова [13](#идентификаторы-и-ключевые-слова)](#идентификаторы-и-ключевые-слова)

[4.1.2. Константы [15](#константы)](#константы)

[4.1.3. Операторы [20](#операторы)](#операторы)

[4.1.4. Специальные знаки [20](#специальные-знаки)](#специальные-знаки)

[4.1.5. Комментарии [21](#комментарии)](#комментарии)

[4.1.6. Приоритеты операторов [22](#приоритеты-операторов)](#приоритеты-операторов)

[4.2. Выражения значения [23](#выражения-значения)](#выражения-значения)

[4.2.1. Ссылки на столбцы [24](#ссылки-на-столбцы)](#ссылки-на-столбцы)

[4.2.2. Позиционные параметры [24](#позиционные-параметры)](#позиционные-параметры)

[4.2.3. Индексы элементов [24](#индексы-элементов)](#индексы-элементов)

[4.2.4. Выбор поля [25](#выбор-поля)](#выбор-поля)

[4.2.5. Применение оператора [25](#применение-оператора)](#применение-оператора)

[4.2.6. Вызовы функций [26](#вызовы-функций)](#вызовы-функций)

[4.2.7. Агрегатные выражения [26](#агрегатные-выражения)](#агрегатные-выражения)

[4.2.8. Вызовы оконных функций [30](#вызовы-оконных-функций)](#вызовы-оконных-функций)

[4.2.9. Приведения типов [34](#приведения-типов)](#приведения-типов)

[4.2.10. Применение правил сортировки [35](#применение-правил-сортировки)](#применение-правил-сортировки)

[4.2.11. Скалярные подзапросы [36](#скалярные-подзапросы)](#скалярные-подзапросы)

[4.2.12. Конструкторы массивов [37](#конструкторы-массивов)](#конструкторы-массивов)

[4.2.13. Конструкторы табличных строк [39](#конструкторы-табличных-строк)](#конструкторы-табличных-строк)

[4.2.14. Правила вычисления выражений [41](#правила-вычисления-выражений)](#правила-вычисления-выражений)

[4.3. Вызов функций [43](#вызов-функций)](#вызов-функций)

[4.3.1. Позиционная передача [44](#позиционная-передача)](#позиционная-передача)

[4.3.2. Именная передача [44](#именная-передача)](#именная-передача)

[4.3.3. Смешанная передача [45](#смешанная-передача)](#смешанная-передача)

[5. Типы данных [46](#типы-данных)](#типы-данных)

[5.1. Числовые типы [48](#числовые-типы)](#числовые-типы)

[5.1.1. Целочисленные типы [48](#целочисленные-типы)](#целочисленные-типы)

[5.1.2. Числа с произвольной точностью [49](#числа-с-произвольной-точностью)](#числа-с-произвольной-точностью)

[5.1.3. Типы с плавающей точкой [51](#типы-с-плавающей-точкой)](#типы-с-плавающей-точкой)

[5.1.4. Последовательные типы [53](#последовательные-типы)](#последовательные-типы)

[5.2. Денежные типы [55](#денежные-типы)](#денежные-типы)

[5.3. Символьные типы [56](#символьные-типы)](#символьные-типы)

[5.4. Двоичные типы данных [58](#двоичные-типы-данных)](#двоичные-типы-данных)

[5.4.1. Шестнадцатеричный формат bytea [59](#шестнадцатеричный-формат-bytea)](#шестнадцатеричный-формат-bytea)

[5.4.2. Формат спецпоследовательностей bytea [59](#формат-спецпоследовательностей-bytea)](#формат-спецпоследовательностей-bytea)

[5.5. Типы даты/времени [61](#типы-датывремени)](#типы-датывремени)

[5.5.1. Ввод даты/времени [63](#ввод-датывремени)](#ввод-датывремени)

[5.5.2. Вывод даты/времени [68](#вывод-датывремени)](#вывод-датывремени)

[5.5.3. Часовые пояса [69](#часовые-пояса)](#часовые-пояса)

[5.5.4. Ввод интервалов [71](#ввод-интервалов)](#ввод-интервалов)

[5.5.5. Вывод интервалов [74](#вывод-интервалов)](#вывод-интервалов)

[5.6. Логический тип [75](#логический-тип)](#логический-тип)

[5.7. Типы перечислений [76](#типы-перечислений)](#типы-перечислений)

[5.7.1. Объявление перечислений [76](#объявление-перечислений)](#объявление-перечислений)

[5.7.2. Порядок [77](#порядок)](#порядок)

[5.7.3. Безопасность типа [78](#безопасность-типа)](#безопасность-типа)

[5.7.4. Тонкости реализации [79](#тонкости-реализации)](#тонкости-реализации)

[5.8. Геометрические типы [79](#геометрические-типы)](#геометрические-типы)

[5.8.1. Точки [80](#точки)](#точки)

[5.8.2. Прямые [80](#прямые)](#прямые)

[5.8.3. Отрезки [80](#отрезки)](#отрезки)

[5.8.4. Прямоугольники [81](#прямоугольники)](#прямоугольники)

[5.8.5. Пути [81](#пути)](#пути)

[5.8.6. Многоугольники [82](#многоугольники)](#многоугольники)

[5.8.7. Окружности [82](#окружности)](#окружности)

[5.9. Типы, описывающие сетевые адреса [83](#типы-описывающие-сетевые-адреса)](#типы-описывающие-сетевые-адреса)

[5.9.1. inet [83](#inet)](#inet)

[5.9.2. cidr [83](#cidr)](#cidr)

[5.9.3. Различия inet и cidr [84](#различия-inet-и-cidr)](#различия-inet-и-cidr)

[5.9.4. macaddr [84](#macaddr)](#macaddr)

[5.9.5. macaddr8 [85](#macaddr8)](#macaddr8)

[5.10. Битовые строки [86](#битовые-строки)](#битовые-строки)

[5.11. Типы, предназначенные для текстового поиска [87](#типы-предназначенные-для-текстового-поиска)](#типы-предназначенные-для-текстового-поиска)

[5.11.1. tsvector [87](#tsvector)](#tsvector)

[5.11.2. tsquery [89](#tsquery)](#tsquery)

[5.12. Тип UUID [90](#тип-uuid)](#тип-uuid)

[5.13. Тип XML [91](#тип-xml)](#тип-xml)

[5.13.1. Создание XML-значений [92](#создание-xml-значений)](#создание-xml-значений)

[5.13.2. Обработка кодировки [93](#обработка-кодировки)](#обработка-кодировки)

[5.13.3. Обращение к XML-значениям [94](#обращение-к-xml-значениям)](#обращение-к-xml-значениям)

[5.14. Типы JSON [94](#типы-json)](#типы-json)

[5.14.1. Проектирование документов JSON [97](#проектирование-документов-json)](#проектирование-документов-json)

[5.14.2. Проверки на вхождение и существование jsonb [97](#проверки-на-вхождение-и-существование-jsonb)](#проверки-на-вхождение-и-существование-jsonb)

[5.14.3. Индексация jsonb [100](#индексация-jsonb)](#индексация-jsonb)

[5.14.4. Обращение по индексу к элементам jsonb [104](#обращение-по-индексу-к-элементам-jsonb)](#обращение-по-индексу-к-элементам-jsonb)

[5.14.5. Трансформации [107](#трансформации)](#трансформации)

[5.14.6. Тип jsonpath [107](#тип-jsonpath)](#тип-jsonpath)

[5.15. Массивы [110](#массивы)](#массивы)

[5.15.1. Объявления типов массивов [110](#объявления-типов-массивов)](#объявления-типов-массивов)

[5.15.2. Ввод значения массива [111](#ввод-значения-массива)](#ввод-значения-массива)

[5.15.3. Обращение к массивам [113](#обращение-к-массивам)](#обращение-к-массивам)

[5.15.4. Изменение массивов [116](#изменение-массивов)](#изменение-массивов)

[5.15.5. Поиск значений в массивах [120](#поиск-значений-в-массивах)](#поиск-значений-в-массивах)

[5.15.6. Синтаксис вводимых и выводимых значений массива [122](#синтаксис-вводимых-и-выводимых-значений-массива)](#синтаксис-вводимых-и-выводимых-значений-массива)

[5.16. Составные типы [124](#составные-типы)](#составные-типы)

[5.16.1. Объявление составных типов [124](#объявление-составных-типов)](#объявление-составных-типов)

[5.16.2. Конструирование составных значений [125](#конструирование-составных-значений)](#конструирование-составных-значений)

[5.16.3. Обращение к составным типам [127](#обращение-к-составным-типам)](#обращение-к-составным-типам)

[5.16.4. Изменение составных типов [127](#изменение-составных-типов)](#изменение-составных-типов)

[5.16.5. Использование составных типов в запросах [128](#использование-составных-типов-в-запросах)](#использование-составных-типов-в-запросах)

[5.16.6. Синтаксис вводимых и выводимых значений составного типа [132](#синтаксис-вводимых-и-выводимых-значений-составного-типа)](#синтаксис-вводимых-и-выводимых-значений-составного-типа)

[5.17. Диапазонные типы [133](#диапазонные-типы)](#диапазонные-типы)

[5.17.1. Встроенные диапазонные и мультидиапазонные типы [134](#встроенные-диапазонные-и-мультидиапазонные-типы)](#встроенные-диапазонные-и-мультидиапазонные-типы)

[5.17.2. Включение и исключение границ [134](#включение-и-исключение-границ)](#включение-и-исключение-границ)

[5.17.3. Неограниченные (бесконечные) диапазоны [135](#неограниченные-бесконечные-диапазоны)](#неограниченные-бесконечные-диапазоны)

[5.17.4. Ввод/вывод диапазонов [135](#вводвывод-диапазонов)](#вводвывод-диапазонов)

[5.17.5. Конструирование диапазонов и мультидиапазонов [136](#конструирование-диапазонов-и-мультидиапазонов)](#конструирование-диапазонов-и-мультидиапазонов)

[5.17.6. Типы дискретных диапазонов [137](#типы-дискретных-диапазонов)](#типы-дискретных-диапазонов)

[5.17.7. Определение новых диапазонных типов [138](#определение-новых-диапазонных-типов)](#определение-новых-диапазонных-типов)

[5.17.8. Индексация [140](#индексация)](#индексация)

[5.17.9. Ограничения для диапазонов [141](#ограничения-для-диапазонов)](#ограничения-для-диапазонов)

[5.18. Типы доменов [142](#типы-доменов)](#типы-доменов)

[5.19. Идентификаторы объектов [142](#идентификаторы-объектов)](#идентификаторы-объектов)

[5.20. Тип pg_lsn [146](#тип-pg_lsn)](#тип-pg_lsn)

[5.21. Псевдотипы [147](#псевдотипы)](#псевдотипы)

[Перечень сокращений [150](#_Toc215498532)](#_Toc215498532)

# Общие сведения о СУБД «Jatoba»

## Назначение СУБД «Jatoba»

СУБД «Jatoba» является программным средством, предназначенным для создания и управления реляционными базами данных на базе ЭВМ под управлением ОС, представленных в таблице Таблица 1.1.
...
СУБД «Jatoba» устанавливается на ЭВМ с процессорами, имеющими архитектуру x86, x86-64 и AMD64 и удовлетворяющими следующим аппаратным требованиям, указанным в таблице Таблица 1.2.

<table>
<caption><p>Таблица . – Программные и аппаратные требования к ЭВМ, на которых функционируют клиентская и серверная часть СУБД</p></caption>
<colgroup>
<col style="width: 37%" />
<col style="width: 38%" />
<col style="width: 23%" />
...
<tr>
<td rowspan="3" style="text-align: center;">Internet браузер</td>
<td style="text-align: center;"><ul>
<li></li>
</ul></td>
<td style="text-align: center;"><blockquote>
<p>Яндекс.Браузер;Х</p>
</blockquote></td>
<td style="text-align: center;"></td>
</tr>
<tr>
...
Таблица . – Программные и аппаратные требования к ЭВМ, на которых функционируют клиентская и серверная часть СУБД
...
> запустить «Терминал»;выполнить вход в систему под пользователем СУБД (в ходе установки СУБД по умолчанию создается пользователь «postgres»):su -l postgres

<img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image3.png" style="width:7.0859in;height:0.9403in" alt="C:\Users\kuznetsov-a\Documents\Jatoba_4\Наработки\TEMP\Screenshot from 2022-10-21 04-21-18.png" />

Рисунок . – Вход в СУБД

3)  

> перейти в рабочий каталог при помощи команды:cd /usr/jatoba-4/bin

<img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image4.png" style="width:7.0859in;height:0.91791in" alt="C:\Users\kuznetsov-a\Documents\Jatoba_4\Наработки\TEMP\Screenshot from 2022-10-21 04-22-53.png" />

Рисунок . – Переход в каталог

4)  

> выполнить команду подключения к СУБД «Jatoba»:psql -U \<учетная запись пользователя в СУБД\> -d \<наименование БД, к которой нужно произвести подключение\>

<img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image5.png" style="width:7.0859in;height:0.93284in" alt="C:\Users\kuznetsov-a\Documents\Jatoba_4\Наработки\TEMP\Screenshot from 2022-10-21 04-24-06.png" />

Рисунок . – Подключение к БД
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | Команде «UPDATE» необходимо, чтобы компонент «SET» всегда стоял в определенном положении, а «INSERT» требует наличие компонента «VALUES». |
|----|----|
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image1.png" style="width:0.25139in;height:0.25139in" /> | Знаки доллара нельзя использовать в идентификаторах, так как их использование вредит переносимости приложений. |
|----|----|
...
− без кавычек – воспринимаются системой без учета регистра. Запись команды

UPDATE MY_TABLE SET A = 5; равносильна записи uPDaTE my_TabLE SeT a = 5;
...
<thead>
<tr>
<th style="text-align: center;"><img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /></th>
<th><p>Используется неформальное соглашение записывать ключевые слова заглавными буквами, а имена строчными:</p>
<p>UPDATE my_table SET a = 5</p></th>
</tr>
</thead>
<tbody>
</tbody>
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image1.png" style="width:0.25139in;height:0.25139in" /> | Идентификаторы в кавычках не являются ключевыми словами. |
|----|----|

| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | «select» можно использовать для обозначения столбца или таблицы «select», но select без кавычек будет воспринято системой как ключевое слово, что приведет к ошибке. |
|----|----|
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image1.png" style="width:0.25139in;height:0.25139in" /> | При этом возникает неоднозначность с оператором &. Для того, чтобы ее избежать, необходимо окружить этот оператор пробелами. |
|----|----|
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image1.png" style="width:0.25139in;height:0.25139in" /> | Это не то же самое, что двойная кавычка ("). |
|----|----|
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | Если константа со спецпоследовательностью разбивается на несколько строк, букву E нужно поставить только перед первым открывающим апострофом. |
|----|----|

Внутри таких строк символ обратной косой черты (\\ начинает C-подобные спецпоследовательности, в которых сочетание обратной косой черты со следующим символом(ами) дает определенное байтовое значение, как показано в таблице Таблица 4.1.
...
Таблица . – Спецпоследовательности
...
<tr>
<th style="text-align: center;"><img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image1.png" style="width:0.25139in;height:0.25139in" /></th>
<th><p>При параметре конфигурации standard_conforming_strings = off, PostgreSQL распознает обратную косую черту как спецсимвол и в обычных строках, и в строках со спецпоследовательностями.</p>
<p>При standard_conforming_strings = on, обратная косая черта распознается только в спецстроках. Это поведение может нарушить работу приложений, рассчитанных на предыдущий режим, когда обратная косая черта распознавалась везде. Если необходимо, чтобы обратная косая черта представляла специальный символ, необходимо задать ее строковую константу с E.</p>
<p>В дополнение к standard_conforming_strings поведением обратной косой черты в строковых константах управляют параметры escape_string_warning и backslash_quote.</p>
<p>Строковая константа не может включать символ с кодом 0.</p></th>
</tr>
</thead>
<tbody>
</tbody>
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | Во избежание неоднозначности с оператором &, необходимо окружить этот оператор пробелами. |
|----|----|
...
<tr>
<th style="text-align: center;"><img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /></th>
<th><p>Спецпоследовательности Unicode в строковых константах работают только когда параметр конфигурации standard_conforming_strings = on.</p>
<p>При standard_conforming_strings = off спецпоследовательности будут вызывать ошибку.</p></th>
</tr>
</thead>
<tbody>
</tbody>
...
Внутри такой строки апострофы не нужно записывать особым образом. В строке, заключенной в доллары, все символы можно записывать в чистом виде: содержимое строки всегда записывается буквально. Ни обратная косая черта, ни даже знак доллара не являются спецсимволами, если только они не образуют последовательность, соответствующую открывающему тегу.
...
> Сочетания символов – и /\* не могут присутствовать в имени оператора, так как они будут обозначать начало комментария.Многосимвольное имя оператора не может заканчиваться знаком + или -, если только оно не содержит также один из этих символов:~ ! @ \# % ^ & \| \` ?
...
Большинство операторов имеют одинаковый приоритет и вычисляются слева направо. Приоритет и очередность операторов жестко фиксированы в синтаксическом анализаторе. В таблице Таблица 4.2 показаны приоритеты и очередность операторов, действующие в PostgreSQL.
...
Таблица . – Приоритет операторов (от большего к меньшему)
...
тогда OPERATOR имеет приоритет по умолчанию, соответствующий в таблице Таблица 4.2 строке «любой другой оператор». Это не зависит от того, какие именно операторы находятся в конструкции OPERATOR().
...
В общем случае выражение массива должно заключаться в круглые скобки, но их можно опустить, когда выражение с индексом – это просто ссылка на столбец или позиционный параметр. Кроме того, можно соединить несколько индексов, если исходный массив многомерный.
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | При использовании агрегатных функций с несколькими аргументами, предложение ORDER BY идет после всех аргументов. |
|----|----|
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | Если же предложение_order_by находится не в WITHIN GROUP, оно не передается как аргумент(ы) агрегатной функции. |
|----|----|
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | В режимах ROWS и GROUPS указания 0 PRECEDING и 0 FOLLOWING равнозначны указанию CURRENT ROW. Обычно это справедливо и для режима RANGE, в случае подходящего для типа данных определения значения «нуля». |
|----|----|
...
> переопределение порядка сортировки в предложении ORDER BY:SELECT a, b, c FROM tbl WHERE ... ORDER BY a COLLATE "C";

- 

> переопределение правил сортировки при вызове функций или операторов, возвращающих языкозависимые результаты:SELECT \* FROM tbl WHERE a \> 'foo' COLLATE "C";
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | Но если в результате выполнения подзапрос не вернет строк, скалярный результат считается равным NULL. |
|----|----|
...
> Приведение не требуется, так как существует только одна getf1()SELECT getf1(ROW(1,2.5,'this is a test'));
>
> getf1
>
> -------
...
> Теперь приведение необходимо для однозначного выбора функции:SELECT getf1(ROW(1,2.5,'this is a test'));
>
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | Это отличается от «оптимизации» вычисления логических операторов слева направо, реализованной в некоторых языках программирования. |
|----|----|
...
Числовые типы включают двух-, четырех- и восьмибайтные целые, четырех- и восьмибайтные числа с плавающей точкой, а также десятичные числа с задаваемой точностью. Все эти типы перечислены в таблице Таблица 5.2.
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | В большинстве реализаций «не число» (NaN) считается не равным любому другому значению (в том числе и самому NaN). Чтобы значения numeric можно было сортировать и использовать в древовидных индексах, PostgreSQL считает, что значения NaN равны друг другу и при этом больше любых числовых значений (не NaN). |
|----|----|
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | Преобразование в кратчайший точный вид производится гораздо быстрее, чем в традиционное представление с округлением. |
|----|----|
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | Приложения, которым были нужны точные числовые значения, раньше задавали для параметра extra_float_digits значение 3, чтобы получить их. Они могут продолжать использовать это значение для максимальной совместимости с разными версиями. |
|----|----|
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | Согласно IEEE 754, NaN не должно считаться равным любому другому значению с плавающей точкой (в том числе и самому NaN). Чтобы значения с плавающей точкой можно было сортировать и использовать в древовидных индексах, PostgreSQL считает, что значения NaN равны друг другу, и при этом больше любых числовых значений (не NaN). |
|----|----|
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | В этом разделе описывается специфичный для PostgreSQL способ создания столбца с автоувеличением. Другой способ, соответствующий стандарту SQL, заключается в использовании столбцов идентификации и рассматривается в описании CREATE TABLE. |
|----|----|
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | Так как типы smallserial, serial и bigserial реализованы через последовательности, в числовом ряду значений столбца могут образовываться пропуски, даже если никакие строки не удалялись. Значение, выделенное из последовательности, считается «задействованным», даже если строку с этим значением не удалось вставить в таблицу. Это может произойти при откате транзакции, добавляющей данные. |
|----|----|
...
В таблице Таблица 5.4 перечислены символьные типы общего назначения, доступные в PostgreSQL.
...
Таблица . – Специальные символьные типы
...
Передавая значения bytea в формате спецпоследовательности, байты с определенными значениями необходимо записывать специальным образом, хотя так можно записывать и все значения. В общем виде для этого значение байта нужно преобразовать в трехзначное восьмеричное число и добавить перед ним обратную косую черту. Саму обратную косую черту (символ с десятичным кодом 92) можно записать в виде двух таких символов. В таблице Таблица 5.7 перечислены символы, которые нужно записывать спецпоследовательностями, и приведены альтернативные варианты записи, если они возможны.
...
Таблица . – Спецпоследовательности записи значений bytea
...
Апострофы должны дублироваться, как показано в таблице Таблица 5.7, потому что это обязательно для любой текстовой строки в команде SQL. При общем разборе текстовой строки внешние апострофы убираются, а каждая пара внутренних сводится к одному символу. Таким образом, функция ввода bytea видит всего один апостроф, который она обрабатывает как обычный символ в данных. Дублировать же обратную косую черту при вводе bytea не требуется: этот символ считается особым и меняет поведение функции ввода, как показано в таблице Таблица 5.7.
...
Байт с десятичным кодом 92 (обратная косая черта) при выводе дублируется. Это иллюстрирует таблица Таблица 5.8.
...
Таблица . – Спецпоследовательности выходных значений bytea
...
PostgreSQL поддерживает полный набор типов даты и времени SQL, показанный в таблице Таблица 5.9. Все даты считаются по Григорианскому календарю, даже для времени до его введения.
...
Таблица . – Типы даты/времени

| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | Стандарт SQL требует, чтобы тип timestamp подразумевал timestamp without time zone (время без часового пояса), и PostgreSQL следует этому. Для краткости timestamp with time zone можно записать как timestamptz; это расширение PostgreSQL. |
|----|----|

Типы time, timestamp и interval принимают необязательное значение точности p, определяющее, сколько знаков после запятой должно сохраняться в секундах. По умолчанию точность не ограничивается. Допустимые значения p лежат в интервале  
от 0 до 6.
...
В таблице Таблица 5.10 приведены некоторые допустимые значения типа date.
...
Таблица . – Специальные значения даты/времени
...
Таблица . – Стили вывода даты/время

| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | ISO 8601 указывает, что дата должна отделяться от времени буквой T в верхнем регистре. PostgreSQL принимает этот формат при вводе, но при выводе вставляет вместо T пробел, как показано выше. Это сделано для улучшения читаемости и для совместимости с RFC 3339 и другими СУБД. |
|----|----|

В стилях SQL и POSTGRES день выводится перед месяцем, если установлен порядок DMY, а в противном случае месяц выводится перед днем. Соответствующие примеры показаны в таблице Таблица 5.15.
...
Таблица . – Соглашения о порядке компонентов даты
...
Строка должна начинаться с символа P и может включать также T перед временем суток. Допустимые коды единиц перечислены в таблице Таблица 5.16. Коды единиц можно опустить или указать в любом порядке, но компоненты времени суток должны идти после символа T. В частности, значение кода M зависит от того, располагается ли он до или после T.
...
Таблица . – Коды единиц временных интервалов ISO 8601
...
В таблице Таблица 5.17 показано несколько примеров допустимых вводимых значений типа interval.
...
Формат вывода типа interval может определяться одним из четырех стилей: sql_standard, postgres, postgres_verbose и iso_8601. Выбрать нужный стиль позволяет команда SET intervalstyle (по умолчанию выбран postgres). Примеры форматов разных стилей показаны в таблице Таблица 5.18.
...
Таблица . – Примеры стилей вывода интервалов
...
Геометрические типы данных представляют объекты в двумерном пространстве. Все существующие в PostgreSQL геометрические типы перечислены в таблице Таблица 5.20.
...
PostgreSQL предлагает типы данных для хранения адресов IPv4, IPv6 и MAC, показанные в таблице Таблица 5.21. Для хранения сетевых адресов лучше использовать эти типы, а не простые текстовые строки, так как PostgreSQL проверяет вводимые значения данных типов и предоставляет специализированные операторы и функции для работы с ними.
...
Таблица . – Типы, описывающие сетевые адреса
...
В таблице Таблица 5.22 показаны несколько примеров адресов.
...
Таблица . – Примеры допустимых значений типа cidr
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | Если не устраивает выходной формат значений inet или cidr, попробуйте функции host, text и abbrev. |
|----|----|
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | При попытке привести значение битовой строки к типу bit(n), оно будет усечено или дополнено нулями справа до длины ровно n бит, ошибки при этом не будет. Подобным образом, если явно привести значение битовой строки к типу bit varying(n), она будет усечена справа, если ее длина превышает n бит. |
|----|----|
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image1.png" style="width:0.25139in;height:0.25139in" /> | Некоторые XML-функции способны работать исключительно с ASCII-данными, если кодировка сервера не UTF-8. В частности, это известная особенность функций xmltable() и xpath(). |
|----|----|
...
Таблица . – Примитивные типы JSON и соответствующие им типы PostgreSQL
...
<tr>
<th style="text-align: center;"><img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /></th>
<th><p>Так как вхождение в JSON проверяется с учетом вложенности, правильно написанный запрос может заменить явную выборку внутренних объектов. Предположим, что есть столбец doc, содержащий объекты на верхнем уровне, и большинство этих объектов содержит поля tags с массивами вложенных объектов. Данный запрос найдет записи, в которых вложенные объекты содержат ключи "term":"paris" и "term":"food", и при этом пропустит такие ключи, находящиеся вне массива tags:</p>
<blockquote>
<p>SELECT doc-&gt;'site_name' FROM websites</p>
<p>WHERE doc @&gt; '{"tags":[{"term":"paris"}, {"term":"food"}]}';</p>
</blockquote>
<p>Этого же результата можно добиться:</p>
<blockquote>
<p>SELECT doc-&gt;'site_name' FROM websites</p>
<p>WHERE doc-&gt;'tags' @&gt; '[{"term":"paris"}, {"term":"food"}]';</p>
</blockquote>
<p>Но данный подход менее гибкий и часто также менее эффективный.</p>
<p>С другой стороны, оператор существования JSON не учитывает вложенность: он будет искать заданный ключ или элемент массива только на верхнем уровне значения JSON.</p></th>
</tr>
</thead>
<tbody>
</tbody>
...
-- Отфильтровать записи предложением WHERE с обращением по ключу. Поскольку результат обращения по ключу будет иметь тип jsonb, такой же тип должно иметь сравниваемое с ним значение. Двойные кавычки добавлены, чтобы строка "value" стала допустимой строкой jsonb:
...
| \$varname | Именованная переменная. Ее значение может быть задано в параметре *vars*, который принимают различные функции обработки JSON. |
| @ | Переменная, представляющая результат вычисления пути в выражениях фильтров. |

Таблица . – Переменные jsonpath

<table>
<caption><p>Таблица . – Операторы обращения в jsonpath</p></caption>
<colgroup>
<col style="width: 30%" />
<col style="width: 69%" />
</colgroup>
<thead>
<tr>
<th style="text-align: center;"><strong>Оператор обращения</strong></th>
<th style="text-align: center;"><strong>Описание</strong></th>
</tr>
</thead>
<tbody>
<tr>
<td style="text-align: left;"><p>.ключ</p>
<p>."$имя_переменной"</p></td>
<td style="text-align: left;">Оператор обращения к члену объекта, выбираемому по заданному ключу. Если имя ключа совпадает с именем какой-либо переменной, начинающимся с $, или не соответствует действующим в JavaScript требованиям к идентификаторам, оно должно заключаться в двойные кавычки и таким образом представляться как строковая константа.</td>
</tr>
<tr>
<td style="text-align: left;">.*</td>
<td style="text-align: left;">Оператор обращения по звездочке, который возвращает значения всех членов, находящихся на верхнем уровне объекта.</td>
</tr>
<tr>
<td style="text-align: left;">.**</td>
<td style="text-align: left;">Рекурсивный оператор обращения по звездочке, который проходит по всем уровням иерархии JSON текущего объекта и возвращает все значения членов, вне зависимости от их уровня вложенности. Это реализованное в PostgreSQL расширение стандарта SQL/JSON.</td>
</tr>
<tr>
<td style="text-align: left;"><p>.**{уровень}</p>
<p>.**{начальный_уровень to конечный_уровень}</p></td>
<td style="text-align: left;">Этот оператор подобен .**, но выбирает только указанные уровни иерархии JSON. Уровни вложенности задаются целыми числами, при этом нулевой уровень соответствует текущему объекту. Для обращения к самому нижнему уровню вложенности можно использовать ключевое слово last. Это реализованное в PostgreSQL расширение стандарта SQL/JSON.</td>
</tr>
<tr>
<td style="text-align: left;">[селектор, ...]</td>
...
<tr>
<td style="text-align: left;">[*]</td>
<td style="text-align: left;">Оператор обращения к элементам массива по звездочке, возвращающий все элементы массива.</td>
</tr>
</tbody>
</table>

Таблица . – Операторы обращения в jsonpath
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | Записывать значения массивов в командах SQL часто бывает удобнее с помощью конструктора ARRAY. В ARRAY отдельные значения элементов записываются так же, как если бы они не были членами массива. |
|----|----|
...
<tr>
<th style="text-align: center;"><img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /></th>
<th><p>PostgreSQL осуществляет развертывание столбцов фактически переводя первую форму во вторую. Таким образом, в данном примере myfunc() будет вызываться три раза для каждой строки и с одним, и с другим синтаксисом. Если это дорогостоящая функция, можно использовать такой запрос:</p>
<blockquote>
<p>SELECT m.* FROM some_table, LATERAL myfunc(x) AS m;</p>
</blockquote>
<p>Размещение вызова функции в элементе FROM LATERAL гарантирует, что она будет вызываться для строки не более одного раза. Конструкция m.* так же разворачивается в m.a, m.b, m.c, но теперь эти переменные просто ссылаются на выходные значения FROM.</p></th>
</tr>
</thead>
<tbody>
</tbody>
...
<p>Сначала обработчик спецпоследовательностей удаляет один уровень обратной косой черты, так что анализатор составного значения получает на вход ("\"\\"). В свою очередь, он передает эту строку процедуре ввода значения типа text, где она преобразуются в "\. Во избежание такого дублирования спецсимволов строки можно заключать в доллары.</p></th>
</tr>
</thead>
<tbody>
</tbody>
...
| <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> | Эти правила очень похожи на правила записи значений для полей составных типов. |
|----|----|
...
Можно также считать дискретным подтип диапазона, в котором четко определены понятия «следующего» и «предыдущего» элемента для каждого значения. Такие определения позволяют преобразовывать границы диапазона из включаемых в исключаемые, выбирая следующий или предыдущий элемент вместо заданного значения. Диапазоны целочисленного типа \[4,8\] и (3,9) описывают одно и то же множество значений; но для диапазона подтипа numeric это не так.
...
Домен — пользовательский тип данных, основанный на другом нижележащем типе. Он может быть определен с условиями, ограничивающими множество допустимых значений подмножеством значений нижележащего типа. В остальном он ведет себя как нижележащий тип — с доменным типом будут работать любые операторы или функции, применимые к нижележащему типу. Нижележащим типом может быть любой встроенный или пользовательский базовый тип, тип-перечисление, массив, составной тип, диапазон или другой домен.
...
Идентификатор объекта (Object Identifier, OID) используется внутри PostgreSQL в качестве первичного ключа различных системных таблиц. Идентификатор объекта представляется в типе oid. Также существуют различные типы-псевдонимы для oid, с именами regсущность. Обзор этих типов приведен в таблице Таблица 5.26.
...
Таблица . – Идентификаторы объектов
...
| <span id="_Toc215498532" class="anchor"></span>Перечень сокращенийASCII | – | American standard code for information interchange |
|----|----|----|
