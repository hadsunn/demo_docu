...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image31_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image176.png)
...
:::info Дополнительная информация
Для СУБД «Jatoba» версии ядра 4 используется версия компонента — 2.3.
...
:::warning Важная информация
После выполнения операций pg_dump/pg_dumpall и pg_restore - требуется сменить пароли для пользователей СУБД, как описано в п. 5.2.4, SQL-командой:
...
:::warning Важная информация
При совместной работе SecurityProfile в одной СУБД с компонентами
...
:::warning Важная информация
В случае, если установка расширения не была выполнена до этого, а параметр был задан, то возможны проблемы с авторизацией по методам отличными от trust.
:::
...
Если параметр securityprofile.default_profile не указан, то к новым пользователям будет применяться профиль default.
...
В качестве профиля по умолчанию может быть выбран один из встроенных профилей парольных политик (см. п.п. 5.1.3.8.1-5.1.3.8.6).
:::
...
##### Отдельные параметры компонента securityprofile.user_idle_days_max
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image51_.png)
...
- более «0», но не более максимального значения переменной INT_MAX. Параметр «securityprofile.password_reuse_max» (минимальное количество смен пароля между использованием одинаковых паролей) может принимать следующие значения:
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image52_.png)

Рисунок 5.2 – Временная диаграмма примера № 1 
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image53_.png)

Рисунок 5.3 – Временная диаграмма примера № 2 
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image54_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image55_.png)

Рисунок 5.5 – Временная диаграмма примера № 4
...
<span id="_bookmark51" class="anchor"></span><sup>3</sup> <sup>)</sup> Местонахождение файла postgresql.conf по умолчанию в ОС семейства GNU/Linux: /var/lib/jatoba/<ver>/data/postgresql.conf
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image223.png)

<span id="_bookmark52" class="anchor"></span>Рисунок 5.6 – Установка расширения «securityprofile» 
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image224.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image225.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image226.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image227.png)

Рисунок 5.10 – Установка длины пароля в профиле «password_user» 

На данном шаге требуемое задание выполнено.

**Пример 2 Установка времени блокировки для профиля по умолчанию**

**Шаг 1.** Установить время блокировки для профиля по умолчанию (например, 30 дней):
...
:::warning Важная информация
В конфигурационном файле postgresql.conf из параметра shared_preload_libraries необходимо удалить значение securityprofile.
:::
...
Компонент «securityprofile» может использоваться с компонентом контроля целостности «ja_CSum» для вызова функций блокирования групп пользователей (см. п. [5.2.1](#блокирование-и-разблокирование-учетных-записей)). Функции блокировки вызываются автоматически, когда компонентом «ja_CSum» обнаружен в СУБД компонент «securityprofile».
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image228.png)
...
```sql
SELECT securityprofile.set_profile_password_life_time('dv_profile', - 1);
```
...
```sql
SELECT securityprofile.set_profile_password_grace_time('dv_profile', - 1);
```
...
```sql
SELECT securityprofile.set_profile_user_idle_days_max('dv_profile', - 1);
```
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image229.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image230.png)



Рисунок 5.13 – SQL-команда блокирования пользователя 
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image231.png)



Рисунок 5.14 – Вывод списка состояния пользователей 
...
###### Блокировка группы пользователей (securityprofile.suspend_users)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image232.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image233.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image234.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image235.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image236.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image237.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image238.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image239.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image240.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image241.png)
...
###### Блокировка группы пользователей администраторов БД (suspend_admins)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image242.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image243.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image244.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image245.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image246.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image247.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image248.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image249.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image250.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image251.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image252.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image536_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image254.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image255.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image256.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image257.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image258.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image542_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image260.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image261.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image262.png)
...
1)  От имени и с правами пользователя «Superuser» авторизоваться в СУБД, и выполнить несколько команд от роли «postgres»:
...
1)  Задать запись событий только для выражения "UPDATE" для колонки «age» в таблице «Test» для пользователя «auditor»:
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image546_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image264.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image265.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image549_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image267.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image551_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image269.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image270.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image554_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image272.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image556_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image557_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image71_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image276.png)
...
1)  Проделать данные шаги на втором сервере, пароль и порт указать точно такие, как на первом сервере, только без остановки службы и удаления содержимого каталога e:\pgdata.

2)  Выдать необходимые доступы в файле e:\pgbase\ph_hba.conf.

3)  В файле e:\pgbase\ppstgresql.conf изменить параметр:
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image73_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image74_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image279.jpeg)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image280.jpeg)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image281.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image282.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image283.jpeg)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image284.png)
...
− «643.72410666.00067-08 98 01-01 «Руководство по настройке. Часть 1. Управление режимом работы узлов кластера. Компонент «jaDog» (версия 1.4.2);

− «643.72410666.00067-08 98 02-01 «Руководство по настройке. Часть 1. Управление режимом работы узлов кластера. Компонент «jaDog» (версия 3.2).
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image285.jpeg)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image91_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image92_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image358.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image359.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image360.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image361.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image362.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image363.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image364.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image365.png)
...
```
systemctl stop jatoba-<ver> systemctl 
start jatoba-<ver> systemctl 
status jatoba-<ver>
```
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image366.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image367.png)
...
### Ошибки, возникающие при использовании профиля парольных политик «securityprofile»

Перечень ошибок, возникающих при использовании профиля парольных политик «securityprofile», приведен в таблице [17.1](#_bookmark165).
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image368.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image369.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image370.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/admin/media/image371.png)
