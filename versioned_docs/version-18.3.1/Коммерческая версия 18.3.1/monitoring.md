---
title: Поддержка мониторинга СУБД
---
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image21_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image31_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image32_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image33_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image34_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image35_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image104.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image105.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image106.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image107.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image108.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image45_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image46_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image47_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image112.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image52_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image53_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image54_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image116.png)
...
http://0.0.0.0:9187
```
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image56_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image57_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image58_.png)
...
:::info Дополнительная информация
Изменение адреса веб-интерфейса целесообразнее сохранить в файле сервиса
«postgres_exporter». Иначе	при	перезагрузке ОС	настройки	компонента вернуться к изначальным, хранящимся в файле сервиса.
:::
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image120.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image121.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image122.png)
...
Строка подключения выполнена в формате схемы URL. Синтаксис строки описан в п. [5.3](#настройка-переменных-окружения) настоящего документа.

В рассматриваемом примере на целевой СУБД:

```
data_source_name:'postgresql://sql_exporter:Password@10.116.102.45:5432/postgres?sslmode=disable'
```
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image64_.png)
...
```
data_source_name: 'postgresql://sql_exporter:Password@10.116.102.47:5432/postgres?sslmode=disable'
```
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image125.jpeg)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image126.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image68_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image69_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image610_.png)
...
:::info Дополнительная информация
Изменение адреса веб-интерфейса целесообразнее сохранить в файле сервиса
«sql_exporter». Иначе при перезагрузке ОС настройки компонента вернуться к изначальным, хранящимся в файле сервиса.
:::
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image130.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image131.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image72_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image73_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image133.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image75_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image135.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image76_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image77_.png)
...
```
# gedit usr/lib/systemd/system/jatoba<ver>_prometheus.service
```

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image78_.png)

Рисунок 7.8 – Содержание файла сервиса «jatoba-5_prometheus.service»

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image138.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image139.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image712_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image713_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image143.png)
...
Настройка каждого из каналов выполняется файле в конфигурационном файле «alertmanager.yml». После установки пакета в конфигурационном файле будет установлены параметры по умолчанию.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image144.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image83_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image84_.png)

Рисунок 8.4 – Поиск сервиса @BotFather Нажать кнопку «Старт».

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image85_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image86_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image149.jpeg)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image88_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image89_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image152.jpeg)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image811_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image154.jpeg)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image155.png)

Рисунок 8.13 – Параметры «маршрута» для отправки предупреждений по каналу Zulip 
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image156.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image157.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image816_.png)
...
Настраивается SSH-соединение на хосте и/или с хостом с установленной системой «Prometheus» (см. п. [9.1](#настройка-ssh-соединения)).
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image91_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image92_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image93_.png)
...
Схема стенда представлена на рисунке 10.1.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image101_.png)
...
Настройка СУБД в кластере для мониторинга выполняется согласно разделу Установка и настройка целевых СУБД.
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image507.png)
...
- job_name: "coordinator"
  static_configs:
    - targets: ['10.116.102.61:9100', '10.116.102.61:9187', '10.116.102.61:9399', '10.116.102.61:9398']
      labels:
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image508.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image509.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image105_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image111_.png)
...
- 
```
# apt install /home/admin/Downloads/jatoba<ver>-sql-exporter_* –y
```

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image836.jpeg)
...
2)  
```
# cp /lib/systemd/system/jatoba<ver>_sql_exporter.service /lib/systemd/system/jatoba<ver>_sql_exporter.citus.service
```

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image837.png)
...
```
# nano /lib/systemd/system/jatoba<ver>_sql_exporter.citus.service
```

И внести следующие изменения:

```
[Service] EnvironmentFile=/usr/jatoba-<ver>/monitoring/default/sql_exporter.citus
```

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image838.jpeg)
...
4)  
```
# cp /usr/jatoba-<ver>/monitoring/default/sql_exporter.yml /usr/jatoba-<ver>/monitoring/default/sql_exporter.citus.yml
```

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image839.png)
...
```
# nano /usr/jatoba-<ver>/monitoring/default/sql_exporter.citus.yml
```

И внести следующие изменения:

```
data_source_name: 'postgresql://sql_exporter:[password]@10.116.102.61:5432/[citus_db]?sslmode=disable' collectors: [citus]
```

Где password – пароль пользователя СУБД, citus_db – название БД, в которой установлено расширение «citus».

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image840.jpeg)
...
```
# cp /usr/jatoba-<ver>/monitoring/default/sql_exporter /usr/jatoba-<ver>/monitoring/default/sql_exporter.citus
```

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image841.png)
...
```
CONF_FILE=/usr/jatoba-<ver>/monitoring/default/sql_exporter.citus.yml LISTEN_ADDRESS=0.0.0.0:9366
```

Здесь для доступа к метрикам компонента «ja_Hipe_Cluster» будет использован сетевой порт 9366.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image842.jpeg)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image843.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image129_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image845.jpeg)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image1211_.png)
...
```
# systemctl stop jatoba<ver>_node_exporter jatoba<ver>_postgres_exporter jatoba<ver>_alertmanager 
...
```
# nano /usr/jatoba-<ver>/monitoring/default/postgres_exporter.backup 
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image847.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image848.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/monitoring/media/image133_.png)

Рисунок 13.3 – Промежуток в данных собранных с экспортёров

## ТЕРМИНЫ И ОПРЕДЕЛЕНИЯ

@ - ГОСТ 34.302.2-91 (ИСО 8859/2-87) «Наборы 8 битных однобайтовых кодированных графических символов. латинский алфавит № 2» определяет символ как, «коммерческое эт» (англ. «commercial ат»).
