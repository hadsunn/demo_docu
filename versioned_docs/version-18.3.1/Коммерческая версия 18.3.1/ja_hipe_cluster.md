---
title: Компонент «ja_Hipe_Cluster»
---

# Компонент «ja_Hipe_Cluster». Высокопроизводительный кластер.
...
− В Приложении 2 приведена инструкция по настройке SSL соединения для ja_Hipe_Cluster.
...
Версия компонента «ja_Hipe_Cluster» для СУБД «Jatoba» 18 содержит только основной функционал, без реализованной дополнительной функциональности для СУБД «Jatoba» 4/5/6.
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image29.jpeg)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image33.jpeg)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image35.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image37.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image25_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image31_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image126.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image127.png)



Рисунок 3.3 – Раздел «Shared Library Preloading» Сохранить внесенные изменения.

### ![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image128.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image129.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image132.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image135.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image137.png)



Рисунок 3.7 – Установка расширения 

В результате операции установятся:
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image138.png)

Рисунок 3.8 – Создание БД «citus_db» на сервере СУБД «Node1» 

– [3.2.5](#установка-расширения-citus) «[Установка расширения «citus»](#установка-расширения-citus);

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image139.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image140.png)

Рисунок 3.10 – Создание БД «citus_db» на сервере СУБД «Node2» 

– [3.2.5](#установка-расширения-citus) «[Установка расширения «citus»](#установка-расширения-citus);

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image141.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image143.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image144.png)

Рисунок 3.7– Регистрация имени хоста координатора на узле СУБД «node1» 

Аналогичное действие выполняется на сервере СУБД «node2». Выполняется SQL-команда:

```sql
SELECT citus_set_coordinator_host('10.116.102.61', 5432);
```

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image145.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image147.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image148.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image149.png)
...
:::info Дополнительная информация
Специальный режим «preferred» недоступен в версии компонента ja_Hipe_Cluster для СУБД «Jatoba» 18.
:::
...
- все транзакции <u>чтения-записи</u> данных выполняются штатно, как в режиме «never»;
...
```
systemctl stop jatoba-6 
systemctl start jatoba-6 s
ystemctl status jatoba-6
```
...
:::info Дополнительная информация
Настройка кластера без суперпользователя (SU) недоступна в версии компонента ja_Hipe_Cluster для СУБД «Jatoba» 18.
:::
...
:::info Дополнительная информация
Указываемый в citus.superuser пользователь обязан иметь атрибут суперпользователя (SU).
...
2)  Создать пользователя с атрибутами суперпользователя и NOLOGIN (рекомендуется), например citus_su_nologin:
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image151.png)
...
ALTER TABLE ads DROP CONSTRAINT ads_pkey , ADD PRIMARY KEY (account_id,id);
...
COPY positions FROM '/var/lib/jatoba/positions.csv';
COMMIT;
```
...
COPY items FROM '/var/lib/jatoba/items.csv'; 
CREATE TYPE coordinates AS (x int, y int);
COMMIT;
...
SELECT truncate_local_data_after_distributing_table('public.github_eve nts');
```
...
**Возвращаемое значение:** N/A Пример:
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image172.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image176.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image178.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image181.png)

<span id="_bookmark61" class="anchor"></span>Рисунок 4.5 – Вывод результата функции citus_add_secondary_node

##### citus_add_secondary_node_replica_check

:::warning Важная информация
Функционал citus_add_secondary_node_replica_check недоступен для СУБД «Jatoba» версий 4 и 18.
:::
...
Функция citus_add_secondary_node_replica_check(), также как и функция citus_add_secondary_node() (см. п. 4.12.2.7), регистрирует новый вторичный узел в кластере для существующего основного узла, однако при этом выполняется проверка следующих условий:

- вторичный или основной узел не существует или недоступен;

- вторичный узел не является репликой основного узла (проверяется по UUID узла).

В случае, если выполняется совпадение по одному из условий, функция citus_add_secondary_node_replica_check() возвращает ошибку.
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image184.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image186.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image188.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image190.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image193.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image195.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image197.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image199.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image201.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image203.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image210.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image214.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image217.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image219.png)
...
- что издержки на изоляцию транзакций отсутствуют или незначительны, когда две или более транзакций не конфликтуют между собою;
...
:::info Дополнительная информация
Все указанные параметры требуют тонкой настройки под конкретную инфраструктуру и нагрузку. После настройки параметров необходимо выполнить перезагрузку службы СУБД.
:::
...
- Все транзакции, кроме запущенных в режиме "READ WRITE", если на уровне экземпляра СУБД, сеанса или отдельной транзакции значение «default_transaction_read_only» установлено в «true»;
...
#### Балансировка с учетом «зон доступности»
...
#### Балансировка при локальном чтении
...
```
sudo apt-get install --only-upgrade jatoba6-ja-hipe-cluster_<ver.build>.citus_amd64
```
...
:::warning Важная информация
На данном этапе, в следствие удаления компонента ja_Hipe_Cluster, будет утеряна вся имеющаяся информация о состоянии и составе высоконагруженного кластера.
:::
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/ja_hipe_cluster/media/image71_.png)
...
:::info Дополнительная информация
«Новый» узел продолжит работать в качестве узла высокопроизводительного кластера либо до ручного переключения (switchover) в компоненте «jaDog» и последующим обновлением списка реплик в таблице pg_dist_node компонента
...
При выполнении настройки высокопроизводительного кластера на основе «ja_Hipe_Cluster» администратор использует IP-адреса узлов. Это позволяет компоненту «jaDog», использовать функцию citus_update_node «ja_Hipe_Cluster» (см. п.п. [4.12.2.2](#_bookmark57)).
...
2)  Проверить, что пользователь может подключаться к СУБД c узла host1 на узел host2:
...
Один из примеров взаимной блокировки приведен ниже в листинге.
...
--------------- T1 ------------------ --------------- T2 -----------------
BEGIN;                                  BEGIN;
UPDATE lockme SET x = 3 WHERE id = 1;   UPDATE lockme SET x = 4 WHERE id = 2;
UPDATE lockme SET x = 3 WHERE id = 2;
-- Ожидание                             UPDATE lockme SET x = 4 WHERE id = 1;
-- Ожидание завершено                   -- ERROR: canceling the transaction since it was involved in a distributed deadlock
COMMIT; 
```
...
:::info Дополнительная информация
В СУБД «Jatoba» тип функции (волатильная, стабильная или иммутабельная) объявляется явно в определении функции. По умолчанию все функции объявляются как волатильные.
:::
...
```sql
/usr/jatoba-6/bin/pg_probackup add-instance -B /var/lib/jatoba/backup_pro -D /var/lib/jatoba/6/data --instance local_db
```
...
```sql
/usr/jatoba-6/bin/pg_probackup backup -B /var/lib/jatoba/backup_pro --instance local_db -b FULL
```
...
```sql
/usr/jatoba-6/bin/pg_probackup backup -B /var/lib/jatoba/backup_pro --instance local_db -b DELTA
```
...
```
/usr/jatoba-6/bin/pg_probackup restore -B /var/lib/jatoba/backup_pro --instance local_db --recovery-target-name="citus_rp1"
```
...
citus.node_conninfo = 'sslcert=/usr/jatoba-6/etc/jatoba-6/postgres.crt 
sslkey=/usr/jatoba-6/etc/jatoba-6/postgres.key
sslrootcert=/usr/jatoba-6/etc/jatoba-6/root.crt 
sslmode=verify-full'
```
...
```
psql -U user1 "host=db.datagile.ru sslcert=user1.crt sslkey=user1.key" -d test
```
...
```sql
#INSERT INTO pg_dist_authinfo VALUES(1,'test', 'sslcert=/usr/jatoba-6/etc/jatoba-6/ user1.crt sslkey=/usr/jatoba-6/etc/jatoba-6/user1.key');
