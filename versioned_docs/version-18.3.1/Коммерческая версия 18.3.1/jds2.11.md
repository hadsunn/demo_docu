...
Раздел «Ландшафт» позволяет управлять кластером серверов СУБД. Раздел представляет собой графическое отображение управления компонентом «jaDog».
...
- отправки писем с вложениями пользователям JDS подписанным на события безопасности.
...
Раздел «Резервное копирование» предназначен для управления резервными копиями.
...
Схема работы компонента при клиент-серверном варианте представлена на рисунке Рисунок 1.1.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image3.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image4.png)

Рисунок . – Схема работы компонента при локальной установке
...
<td style="text-align: center;">1.8.0-2159</td>
</tr>
<tr>
...
<td style="text-align: center;">0.18.6</td>
</tr>
<tr>
...
<td style="text-align: center;">0.27.0-3083</td>
</tr>
<tr>
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image5.png)

Рисунок . – Компоненты целевой СУБД, требуемые для работы разделов JDS
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image6.png)

Рисунок . – Перечень разделов JDS, доступных для работы с СУБД PostgreSQL
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image7.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image8.png)

Рисунок . – Создание специализированной роли
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image9.png)

Рисунок . – Окно просмотра назначенных прав доступа
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image10.png)

Рисунок . - Модель ролевой консолидации
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image11.png)

Рисунок . – Вкладка «Пользователи» («Users»)
...
Таблица . – Параметры создания пользователя
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image12.png)

Рисунок . – Редактирование конфигурационного файла подключений
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image13.png)

Рисунок . - Окно «Новое подключение»
...
- Пользователи в группе: \* - атрибут группы, значение которого содержит информацию о пользователях, состоящих в этой группе.Созданное подключение отразится в общем списке подключений.
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image14.png)

Рисунок . – Окно «Создание пользователя» JDS с LDAP аутентификацией
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image15.png)

Рисунок . – Создание группы пользователей с LDAP аутентификацией
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image16.png)

Рисунок . – LDAP аутентификация
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image17.png)
...
<table>
<caption><p>Таблица . – Парольные политики для пользователей JDS</p></caption>
<colgroup>
<col style="width: 2%" />
<col style="width: 24%" />
<col style="width: 36%" />
...
Таблица . – Парольные политики для пользователей JDS
...
- Распознается кодировка файла (UTF-8, UTF-16-LE, UTF-16-BE). 

Для файлов без BOM предполагается кодировка UTF-8.Для файлов без BOM (Byte Order Mark) осуществляется проверка на «двоичность»: количество байт "перевод строки" не должно быть менее 1/100 от общего количества байт. Данная проверка исходит из предполагаемого содержимого файла (список «популярных» паролей), в котором скорее всего средняя длина пароля не будет больше 100 символов. Если обнаружен двоичный файл, загрузка блокируется.
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image18.png)

Рисунок . – Контекстное меню в строке пользователя JDS
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image19.png)

Рисунок . – Смена пользователем JDS выданного пароля при первом входе
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image20.png)

Рисунок . – Пиктограмма текущего пользователя

При истечении срока действия пароля пользователь будет периодически получать сообщение о смене пароля.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image21.png)

Рисунок . – Сообщение о смене пароля
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image22.png)

Рисунок . – Окно смены пароля пользователя JDS
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image23.png)

Рисунок . – Принудительное блокирование пользователя JDS
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image24.png)

Рисунок . – Разблокировка пользователя JDS
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image25.png)

Рисунок . – Вкладка «Источники данных»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image26.png)

Рисунок . – Окно добавления нового источника данных
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image27.png)

Рисунок . – Окно «Опрашиваемые экспортеры и наблюдаемые СУБД»

Перечень полей окна «Опрашиваемые экспортеры и наблюдаемые СУБД» приведен в таблице Таблица 2.4.

<table>
<caption><p>Таблица . - Перечень полей</p></caption>
<colgroup>
<col style="width: 23%" />
<col style="width: 76%" />
</colgroup>
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image28.png)

Рисунок . – Поле «Источник данных»
...
<table>
<caption><p>Таблица . – Параметры пакетного сценария «Remove expired refresh tokens»</p></caption>
<colgroup>
<col style="width: 15%" />
<col style="width: 31%" />
<col style="width: 14%" />
...
<table>
<caption><p>Таблица . – Требуемые параметры для подключения целевой СУБД</p></caption>
<colgroup>
<col style="width: 8%" />
<col style="width: 0%" />
<col style="width: 21%" />
...
Таблица . – Требуемые параметры для подключения целевой СУБД
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image29.png)

Рисунок . – Структура раздела «Ландшафт»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image30.png)

Рисунок . - Хост. Вкладка «Обзор»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image31.png)

Рисунок . – Вкладка «Обзор»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image32.png)

Рисунок . - Вкладка «Список БД»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image33.png)
...
- Изменением конфигурационного файла, т.е. его перезаписью.
 ...
 ![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image34.png)

Рисунок . – Окно изменение параметра
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image35.png)

Рисунок . – Индикация о внесенных изменениях
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image36.png)

Рисунок . – Строка параметра измененная средствами компонента JDS
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image37.png)

Рисунок . – Добавление параметра в шаблон
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image38.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image39.png)

Рисунок . – Параметры импортированного шаблона конфигурации
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image40.png)

Рисунок . – Контекстное меню шаблона
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image41.png)

Рисунок . - Конфигурационный файл «postgresql.auto.conf» с дозаписанными параметрами
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image42.png)

Рисунок . – Вкладка «Правила доступа»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image43.png)

Рисунок . - Редактор конфигурационного файла «pg_hba.conf»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image44.png)

Рисунок . – Окно «Откатить изменения»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image45.png)

Рисунок . – Вкладка доступные расширения
...
<table>
<caption><p>Таблица . – Влияние параметров на возможность управления расширениями</p></caption>
<colgroup>
<col style="width: 24%" />
<col style="width: 26%" />
<col style="width: 23%" />
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image46.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image47.png)

Рисунок . – Вкладка «Основные параметры» (Main settings)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image48.png)

Рисунок . - Вкладка «Атрибуты» (Attributes)
...
| ![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image2.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image49.png)

Рисунок . – Окно добавления ролей
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image50.png)

Рисунок . – Выполнение SQL-команды добавления роли «role_2» в состав роли «role_1»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image51.png)

Рисунок . – Иерархия ролей при шаге 1
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image52.png)

Рисунок . – Выполнение SQL-команды добавления роли «role_1» в состав роли «role_3»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image53.png)

Рисунок . – Иерархия ролей при шаге 2
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image54.png)

Рисунок . - Выполнение SQL-команды добавления роли «role_3» в состав роли «role_2»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image55.png)

Рисунок . – Всплывающее сообщение об ошибке

Ошибка возникнет из-за нарушения иерархии ролей.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image56.png)

Рисунок . – Ошибка построения иерархии ролей. Закольцованность структуры
...
<table>
<caption><p>Таблица . – Назначаемые привилегии</p></caption>
<colgroup>
<col style="width: 4%" />
<col style="width: 4%" />
<col style="width: 22%" />
...
Таблица . – Назначаемые привилегии
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image57.png)

Рисунок . – Окно назначение привилегий
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image58.png)

Рисунок . – Выбор назначения роли
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image59.png)

Рисунок . - Вкладка «Назначение ролей»

Установив для роли назначение «Суперпользователь», станут доступны настройки аутентификации по паролю и по SSL-сертификату.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image60.png)

Рисунок . – Вкладка настройки аутентификации по SSL-сертификату
...
1)	Только при назначении другой роли на «Сбор снимков производительности», будут назначены специфические привилегии (см. ниже пункт «Для назначения» Сбор снимков производительности)

2)	Выполнение требований ИБ, где необходимо минимизировать привилегии у роли, не требующей использования привилегии SU.
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image61.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image62.png)

Рисунок . – Сообщение о создании роли
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image63.png)

Рисунок . – Смена пароля пользователя СУБД
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image64.png)

Рисунок . – Окно «Удаление роли»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image65.png)

Рисунок . - Окно сообщения «Конфликты зависимостей»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image66.png)

Рисунок . – Окно «Конфликты зависимостей» с выводом подробной информации
...
- получения информации о действиях отдельных пользователей, как рядовых пользователей, так и администраторов (РСБ.8), в том числе полнотекстовой записи привилегированных команд (РСБ.2а).JDS обладает функциональной возможностью просмотра событий с целевых СУБД. События собираются в служебной БД компонента «ja_Log».
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image67.png)

Рисунок . – Вкладка «Список событий»
...
<table>
<caption><p>Таблица . – Поля фильтра событий</p></caption>
<colgroup>
<col style="width: 19%" />
<col style="width: 19%" />
<col style="width: 19%" />
...
Таблица . – Поля фильтра событий

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image68.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image69.png)
...
Таблица . – Структура столбца «Error message»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image70.png)

Рисунок . – Строка поиска и вывод
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image71.png)

Рисунок . – Выпадающий список проблем для сканирования
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image72.png)

Рисунок . – Список созданных правил сканирования

### Режим сканирования

Переход в режим сканирования выполняется при нажатии на гиперссылку в имени правила сканирования в одноименной вкладке.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image73.png)

Рисунок . – Вкладка «Результаты сканирования»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image74.png)

Рисунок . – Список ранее найденных проблем

Для выявленных проблем отображается их статус в виде пиктограмм.

| **Пиктограмма**                                                   | **Описание**              |
|:-----------------------------------------------------------------:|---------------------------|
| ![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image75.png) | Найдена проблема          |
| ![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image76.png) | Запланировано исправление |
| ![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image77.png) | Поставлена в очередь      |
| ![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image78.png) | Исправление запущено      |

Таблица . – Описание пиктограмм
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image79.png)

Рисунок . – Схема возможных вариантов исправления
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image80.png)

Рисунок . – Установка параметров и даты исправления проблемы
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image81.png)

Рисунок . – Отображение выполняемых SQL-команд

### Вкладка «Задачи»

Выбранные проблемы для исправления передаются в общий список на вкладке «Задачи».

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image82.png)

Рисунок . – Список задач на вкладке «Задачи»
...
- обновить список задач или установить автоматическое обновление во временном диапазоне:
  - 30 секунд;
  - 1 минута;
  - 5 минут.
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image83.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image84.png)

Рисунок . – Общая информация о задаче и рекомендациями по исправлению
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image85.png)

Рисунок . – Отмена запланированной задачи
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image86.png)

Рисунок . – Отображение текущих сессий
...
Таблица . – Столбцы вкладки «Сессии»
...
Таблица . – Возможные значения поля «Состояние» (State)
...
Таблица . – Вспомогательные поля окна завершения сессии на вкладке «Сессии»

Во вложенном окне «Запрос» отражается выполняемый запрос, который возможно скопировать в буфер обмена.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image87.png)

Рисунок . – Дополнительное окно «Завершение сессии» в вкладке «Сессии»
...
Таблица . – Основные отображаемые поля вкладки «Блокировки»
...
Таблица . – Вспомогательные поля окна завершения сессии на вкладке «Блокировки»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image88.png)

Рисунок . – Вкладка «Подключения»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image89.png)

Рисунок . – Окно создания профиля синхронизации в версии JDS
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image90.png)

Рисунок . – Сообщение создания профиля
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image91.png)

Рисунок . – Вкладка «ALD Pro»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image92.png)

Рисунок . – Вкладка «FreeIPA»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image93.png)

Рисунок . – Окно создания профиля Samba
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image94.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image95.png)

Рисунок . – Создание профиля синхронизации с сервером активного каталога «Samba»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image96.png)

Рисунок . – Контекстное меню редактирования профиля
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image97.png)

Рисунок . – Профили маппинга
...
Таблица . – Наименование полей профиля маппинга

Окно создания профиля маппинга представлено на рисунке Рисунок 13.10

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image98.png)

Рисунок . – Окно создания профиля маппинга
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image99.png)

Рисунок . – Сообщение создание профиля маппинга
...
При заполнении обязательных полей поле заполниться автоматически.Строка параметра может иметь следующий вид:
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image100.png)

Рисунок . – Содержимое файла «default.conf»

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image101.png)

Рисунок . – Окно создания профиля маппинга для сервера FreeIPA
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image102.png)

Рисунок . – Вывод свойств группы
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image103.png)

Рисунок . – Окно создания профиля маппинга для сервера Samba
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image104.png)

Рисунок . – Контекстное меню редактирования профиля маппинга
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image105.png)

Рисунок . – Окно редактирования профиля маппинга
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image106.png)
...
- Corporate_3 – корпоративный профиль третьего уровня для технических (сервисных, служебных) учетных записей, используемых в технологических процессах ИС или встроенных производителями программных (программно-аппаратных) средств.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image107.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image108.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image109.png)

Рисунок . – Вкладка «securityprofile»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image110.png)

Рисунок . – Вкладка «checksum»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image111.png)

Рисунок . – Окно разблокирования группы пользователей
...
Таблица . - Список отображаемых параметров БД
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image112.png)

Рисунок . - Вкладка «Обзор» БД
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image113.png)

Рисунок . – Вкладка «Расширения»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image114.png)

Рисунок . - Окно «Установка расширения»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image115.png)

Рисунок . – Удаление расширения в БД и окно подтверждения
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image116.png)

Рисунок . – Окно уставки расширения pg_profile

Установка выполняется методом «CASCADE» и вместе с ним установится расширение dblink.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image117.png)

Рисунок . – Установленные расширения на целевой СУБД
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image118.png)

Рисунок . - Вкладка «Обзор» расширения
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image119.png)

Рисунок . – Вкладка «Настройки сервера»
...
Таблица . – Параметры создаваемого виртуального сервера

Примечание:

\* - обязательные параметры.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image120.png)

Рисунок . – Окно добавления нового сервера
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image121.png)

Рисунок . – Окно применения параметров
...
Таблица . – Параметры расширения

Имеющиеся параметры доступны для редактирования.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image122.png)
...
<img src="@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image125.png)
...
<img src="@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image126.png)

Рисунок . – Гиперссылка расширения securityprofile
...
Таблица . – Отображаемые параметры расширения securityprofile
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image127.png)

Рисунок . – Окно установки расширения ja_csum
...
Таблица . – Аббревиатуры атрибутов ролей
...
Таблица . – Условные обозначения привилегий пользователей
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image128.png)

Рисунок . – Окно субъектов доступа

При установке или снятии флага матрица перестраивается автоматически.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image129.png)

Рисунок . – Вид «Матрицы доступа»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image130.png)

Рисунок . – Вид окна фильтра «Матрицы доступа»
...
Таблица . – Условные обозначения системных привилегий и атрибутов ролей
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image131.png)

Рисунок . – Цветовая индикация
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image132.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image133.png)

Рисунок . – Навигация в подразделах Ландшафта
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image134.png)

Рисунок . – Путь к параметрам кластера
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image135.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image136.png)

Рисунок . – Вкладка «Обзор» кластера
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image137.png)

Рисунок . - Вкладка «Список узлов»
...
- REWINDING – резервный узел в процессе переключения на новый главный узел.STARTING – узел находится в состоянии запуска.RESTARTING – узел находится в состоянии перезапуска.DEMOTING – главный узел в процессе преобразования в резервный;
...
В поле «LSN и отставания» отображается разница между двумя позициями в журнале предзаписи.

**Отставание** - факт, состоящий в том, что транзакции на реплике выполняются позже, чем на мастере. По функции pg_wal_lsn_diff (lsn1 pg_lsn, lsn2 pg_lsn) → numeric вычисляется разница в байтах (lsn1 - lsn2) между двумя позициями в журнале предзаписи (Мастера и Реплики). Полученный результат можно использовать для определения задержки репликации

**LSN** (Log Sequence Number) в СУБД — это байтовое смещение до записи относительно начала журнала предзаписи (WAL). LSN — это 64-битное целое число, которое представляет собой указатель на позицию в потоке WAL.

LSN используется для:

- Описания позиции вставки в WAL. Записи WAL добавляются в файлы WAL по мере записи каждой новой записи, и LSN описывает позицию вставки.
- Контроля порядка записи изменений в табличных страницах. Порядок контролируется с учётом LSN последнего изменения страницы и текущего состояния pg_current_wal_lsn.
- Оценки объёма журнальных записей между двумя позициями LSN. Зная две позиции LSN, можно получить размер журнальных записей между ними (в байтах) простым вычитанием одной позиции из другой.
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image138.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image139.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image140.png)

Рисунок . – Расположение кнопки «Подключить»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image141.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image142.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image143.png)
...
Данный параметр подключения используется в случае, если узел кластера был подготовлен и на него были заранее скопированы данные с основного узла. При подключении такого узла кластера данные с основного узла копироваться не будут.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image144.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image145.png)

Рисунок . – Окно добавления узла в кластер с каскадной репликацией
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image146.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image147.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image148.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image149.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image150.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image151.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image152.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image153.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image154.png)

Рисунок . – Контекстное меню кластера.

После выбора опции «Отключить» компонент выведет окно подтверждения действия.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image155.png)

Рисунок . – Окно «отключение кластера»
...
- 
- ![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image156.png)

Рисунок . - Кнопка «Включить режим обслуживания»

Перед включением режима ТО компонент выведет информационное сообщение.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image157.png)

Рисунок . – Информационное сообщение о включении режима ТО
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image158.png)

Рисунок . – Список узлов кластера в режиме ТО
...
- Раздел Ландшафт → Кластеры jaDog → Обзор (кластера) → Кнопка «Отключить режим обслуживания».
- 
- Если кластер был введен в режим ТО, то отдельный вывод узлов кластера из данного режима недоступен.
...
В строке узла кластера, через контекстное меню, выбирается опция «Включить режим обслуживания».

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image159.png)

Рисунок . - опция «Включить режим обслуживания» к строке узла кластера
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image160.png)

Рисунок . – Узлы с каскадной репликацией в режиме ТО

Вывод из режима технического обслуживания узла кластера выполняется переходом по пути:

- Раздел Ландшафт → Кластеры jaDog → Список узлов.
- 
- В строке узла кластера, через контекстное меню, выбирается опция «Отключить режим обслуживания».
...
- 
- ![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image161.png)

Рисунок . – Запуск реинициализации узла кластера

- реинициализации узла кластера без копирования данных с узла с ролью «Master».
- 
- ![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image162.png)

Рисунок . Запуск реинициализации узла кластера без копирования данных
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image163.png)

Рисунок . – Схема взаимодействия компонент для сбора метрик
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image164.png)
...
Таблица . – Перечень виджетов в библиотеке виджетов
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image165.png)

Рисунок . – Окно «Библиотека виджетов»
...
Нужный для виджета экспортёр может быть не подключен, не сконфигурирован, не отвечать по каким-то причинам, из-за чего в Prometheus не сохраняются нужные данные; также может быть, что не удается выполнить сопоставление адреса экспортера и адреса СУБД, отсутствуют метрики pg_static, pg_server, node_os_info.
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image166.png)

Рисунок . – Окно добавления панели виджетов
...
Таблица . – Перечень виджетов для ja_Hipe_Cluster
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image167.png)

Рисунок . – Виджеты кластера
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image168.png)

Рисунок . – Панель виджетов для кластера jaDog
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image169.png)

Рисунок . – Контекстное меню виджета

Выбор данной опции вызовет окно настройки уведомлений.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image170.png)

Рисунок . – Окно уведомления
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image171.png)

Рисунок . – Настройка уведомлений для виджета
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image172.png)

Рисунок . – Вид вкладки «Запросы»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image173.png)

Рисунок . – Вкладка «по шаблонам»

**Визуализация плана запроса**

При клике по конкретному шаблону открывается список запусков запроса по времени.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image174.png)

Рисунок . - Список запусков запроса по времени
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image175.png)

Рисунок . – Визуализация explain по узлам

Визуализированный план запроса возможно экспортировать в PDF-файл через пиктограмму «Adobe Acrobat».

- вкладка «диаграмма»;

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image176.png)

Рисунок . – Визуализация на вкладке «диаграмма»

- вкладка «отношения»;

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image177.png)

Рисунок . – Визуализация на вкладке «отношения»

- вкладка «план»;

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image178.png)

Рисунок . – Визуализация на вкладке «план»

- вкладка «модель»;

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image179.png)

Рисунок . – Визуализация на вкладке «модель»

- вкладка «оригинал».

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image180.png)

Рисунок . – Визуализация на вкладке «оригинал»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image181.png)

Рисунок . – Вид вкладки «Мегазапросы»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image182.png)

Рисунок . – Вкладка «по приложениям»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image183.png)

Рисунок . – Вкладки визуализации запроса.
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image184.png)

Рисунок . – Вид вкладки «Блокировки»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image185.png)

Рисунок . – Вкладка «по типам»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image186.png)

Рисунок . – Вывод анализа плана запроса
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image187.png)

Рисунок . – Вкладка «по хостам»
...
Таблица . – Столбцы страницы списка классов ошибок для выбранного хоста

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image188.png)

Рисунок . - Страница списка классов ошибок для выбранного хоста
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image189.png)

Рисунок . - Страница описания запроса, выполненного с ошибкой

Полное описание ошибки показывается при нажатии на ее строку.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image190.png)

Рисунок . – Полное описание ошибки
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image191.png)

Рисунок . - Вкладка «по ошибкам»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image192.png)

Рисунок . – Список хостов на которых проявилась ошибка
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image193.png)

Рисунок . – Вкладка «Статистика»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image194.png)

Рисунок . – Дополнительные настройки журнала аудита СУБД
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image_.png)

Полученный результат форматирования запроса возможно сохранить через буфер обмена.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image195.png)

Рисунок . – Окно «Форматировать запрос»
...
 ![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image196.png)

Рисунок . - Окно «План запроса для анализа»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image197.png)

Рисунок . – Ошибка визуализации плана запроса
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image198.png)

Рисунок . – Сообщение об успешной визуализации плана запроса
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image199.png)

Рисунок . – Текстовое представление плана запроса
...
Просмотр подробных данных каждого узла в развернутом виде возможен при клике по строке узла, как показано на рисунке Рисунок 21.29.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image200.png)

Рисунок . - Просмотр подробных данных узла в развернутом виде
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image201.png)

Рисунок . – Диаграмма тайтлов
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image202.png)

Рисунок . – Круговая диаграмма 
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image203.png)

Рисунок . – Функциональная диаграмма
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image204.png)

Рисунок . – Модель плана запроса
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image205.png)

Рисунок . – Диаграмма отношения таблиц
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image206.png)

Рисунок . – Рекомендации по плану запроса
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image207.png)

Рисунок . – Подраздел «Подключения JDS»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image208.png)

Рисунок . – Отображение дополнительной информации о подключении пользователя JDS
...
<table>
<caption><p>Таблица . – Требуемые параметры для настройки для probackup</p></caption>
<colgroup>
<col style="width: 27%" />
<col style="width: 20%" />
<col style="width: 51%" />
...
Таблица . – Требуемые параметры для настройки для probackup

### Вкладка «Хранилища»

Во вкладке «Хранилища» раздела «Ландшафт» настраивается хранилища, в котором и будут храниться резервные копии СУБД.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image209.png)
...
<table>
<caption><p>Таблица . – Требуемые параметры для хранилища резервных копий</p></caption>
<colgroup>
<col style="width: 27%" />
<col style="width: 26%" />
<col style="width: 6%" />
...
<tr>
<td style="text-align: center;">![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image2.png)
...
Таблица . – Требуемые параметры для хранилища резервных копий
...
<table>
<caption><p>Таблица . – Требуемые параметры для создания резервной копии</p></caption>
<colgroup>
<col style="width: 27%" />
<col style="width: 27%" />
<col style="width: 44%" />
...
Таблица . – Требуемые параметры для создания резервной копии
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image210.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image211.png)

Рисунок . - Создание «Снимка»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image212.png)

Рисунок . – Экспорт снимков
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image213.png)

Рисунок . – Создание baseline по снимкам
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image214.png)

Рисунок . – Окно «Создание отчета»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image215.png)

Рисунок . – Список отчетов

Просматриваемый отчет откроется в отдельной вкладке браузера.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image216.png)

Рисунок . – Форма отчета «Snapshots & Reports»
...
В поле вносится порт хоста почтового сервера. При использовании SSL-соединения указывается порт – 465. Для SMTP протокола указывается порт ТСР – 25.
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image217.png)

Рисунок . – Окно «Создание Email подключения»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image218.png)

Рисунок . – Окно настройки Zulip бота

Автоматически откроется вкладка «Активные боты»

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image219.png)

Рисунок . – Вкладка «Активные боты»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image220.png)

Рисунок . – Окно «Создание Zulip подключения»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image221.png)

Рисунок . – Список подключений Zulip
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image222.png)

Рисунок . – Вкладка «Настройки обработки»

Изменить преднастроенные параметры можно от имени и с правами администратора компонента JDS, в каталоге веб-сайта в конфигурационном файле appsettings.json. В файле изменяется параметр «Interval» на целое число.
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image223.png)

Рисунок . – Схема создания подписки
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image224.png)

Рисунок . – Окно «Создание канала событий»

Созданный канал событий отразится в общем списке.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image225.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image226.png)

Рисунок . – Контекстное меню операций с каналом событий
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image227.png)

Рисунок . – Кнопка добавления подписчика

Нажатие на кнопку вызовет окно «Создание подписки».

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image228.png)

Рисунок . – Окно «Создание подписки»
...
ля установки «Службы сообщений» требуется в выпадающем списке выбрать:
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image229.png)

Рисунок . – Список подписчиков канала событий
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image230.png)

Рисунок . – Контекстное меню редактирования подписчика
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image231.png)

Рисунок . – Поле «Тип события»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image232.png)

Рисунок . – Окно «Классы и коды ошибок»
...
<u>Мера защиты УПД.1 в части следующего требования:</u>

- оповещение администратора, об изменении сведений о пользователях, их ролях, обязанностях, полномочиях, ограничениях.

<u>Усиление меры защиты УПД.1(5) в части следующего требования:</u>


- автоматический контроль заведения, активации, блокирования и уничтожения учетных записей пользователей и оповещение администраторов о результатах автоматического контроля.(УПД.9) «Ограничение числа параллельных сеансов доступа для каждой учетной записи пользователя информационной системы».

<u>Усиление меры защиты УПД.9 (4) в части следующего требования:</u>
...
будет выполняться поиск в служебной БД «ja_log» по набору ключевых фраз приведенных в таблице Таблица 25.1, для обеспечения меры безопасности УПД.1(5).

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image233.png)

Рисунок . – Создание канала по типу события «События учетных записей»
...
<table>
<caption><p>Таблица . – Соответствие пунктов поля «События» с ключевыми фразами и мерами безопасности</p></caption>
<colgroup>
<col style="width: 20%" />
<col style="width: 40%" />
<col style="width: 20%" />
...
Таблица . – Соответствие пунктов поля «События» с ключевыми фразами и мерами безопасности
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image234.png)

Рисунок . – «Тип события» «Произвольный текст»
...
Таблица . – Перечень типа событий и событий канала JDS
...
На вкладе «Очередь» в правом верхнем углу нажать пиктограмму «Добавить». После чего откроется окно «Создания сообщения» (Create a message).

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image235.png)

Рисунок . – Окно «Создания сообщения»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image236.png)

Рисунок . – Окно выбора вложения
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image237.png)

Рисунок . – Письмо сформированное на вкладе «Очередь сообщений» компонента JDS
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image238.png)

Рисунок . – Вкладка «Обработчики»
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/jds2.11/media/image239.png)

Рисунок . – Вкладка «Журнал сообщений»
...
<table>
<caption><p>Таблица . – Параметры журналирования</p></caption>
<colgroup>
<col style="width: 27%" />
<col style="width: 72%" />
</colgroup>
...
Таблица . – Параметры журналирования
...
- проверить права на директорию бэкапа от ROOT для учетной записи postgres;
...
<span id="_Toc225259251" class="anchor"></span>Термины и определения**Целевая СУБД** – СУБД являющаяся целью мониторинга.
...
Для UTF‑8 BOM — это последовательность трёх байтов: EF BB BF (в шестнадцатеричном представлении).

## ПЕРЕЧЕНЬ СОКРАЩЕНИЙ

| &lt;span id="_Toc225259252" class="anchor"&gt;&lt;/span&gt;Перечень сокращенийAPI | Application programming interface                                |
|-----------------------------------------------------------------------------------|------------------------------------------------------------------|
