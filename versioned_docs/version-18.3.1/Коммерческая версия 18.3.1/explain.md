---
title: Поддержка мониторинга СУБД в части анализа запросов
---
...
- Компонент «pg-monitor-dispatcher». Версия компонента – 1.15.2.
...
ядра 5.x, для других версий все шаги выполняются аналогично, разница состоит
в именах директорий.
...
Примеры команд приведены для операционной системы Ubuntu 20.04. При
развертывании в ОС, использующих систему управления пакетами RPM,
необходимо заменить команды «apt install» на соответствующие команды
(dnf/yum).
:::
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image21_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image22_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image273.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image274.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image275.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image276.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image277.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image36_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image279.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image280.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image281.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image282.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image283.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image284.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image285.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image286.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image287.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image288.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image289.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image411_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image291.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image292.png)
...
:::info Дополнительная информация
В зависимости от версии операционной системы названия файлов могут отличаться
:::

Затем утилита предложит ввести пароль для дополнительного шифрования ключа на диске. Его можно не указывать, нажав «Enter».

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image293.png)

Рисунок 4.14 – Шаг ввода пароля для генерируемого ключа 

Далее утилита сгенерирует ключи SSH.

![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image294.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image295.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image296.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image297.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image298.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image299.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image300.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image301.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image302.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image424_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/imageNN_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image358.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image359.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image360.png)


```
openssl req -x509 -nodes -days 3650 -newkey rsa:4096 -keyout /etc/nginx/ssl/nginx-explain.key explain.crt -out /etc/nginx/ssl/nginx-explain.crt
```


![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image53_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image361.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image362.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image363.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image57_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image58_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image59_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image510_.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image414.png)
...
:::info Дополнительная информация
Сервис explain работает на том же хосте, что и JDS, но в свойстве BaseAddress
нужно указывать внешний IP-адрес (не localhost), т.к. обращение к pg-explain идет не от JDS, а от веб-браузера пользователя.
:::
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image415.png)
...
```sql
sed -i 's/usr\pgsql-14\bin\/usr\jatoba-6\bin\/g' ./scripts/repack.sh
```
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image417.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image418.png)
...
![](@site/versioned_docs/version-18.3.1/assets/images/com18.3.1/explain/media/image419.png)
