...
- на серверах целевых СУБД устанавливается экспортера «node_exporter» (см. р. 4);
- на целевых СУБД устанавливаются утилиты сбора метрик, такие как:
