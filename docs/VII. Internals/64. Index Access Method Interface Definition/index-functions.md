---
title: 64.2. Index Access Method Functions
---
...
Estimate the costs of an index scan. This function is described fully in [Section 64.6](</VII. Internals/64. Index Access Method Interface Definition/index-cost-estimation.md>), below.
...
The purpose of an index, of course, is to support scans for tuples matching an indexable `WHERE` condition, often called a _qualifier_ or _scan key_. The semantics of index scanning are described more fully in [Section 64.3](</VII. Internals/64. Index Access Method Interface Definition/index-scanning.md>), below. An index access method can support “plain” index scans, “bitmap” index scans, or both. The scan-related functions that an index access method must or may provide are:
