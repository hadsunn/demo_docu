---
title: Chapter 65. Generic WAL Records
---
...
In comparison with [Custom WAL Resource Managers](</VII. Internals/custom-rmgr.md>), Generic WAL is simpler for an extension to implement and does not require the extension library to be loaded in order to apply the records.

### Note

Generic WAL records are ignored during [Logical Decoding](</V. Server Programming/49. Logical Decoding/49. Logical Decoding.md>). If logical decoding is required for your extension, consider a Custom WAL Resource Manager.
