---
title: 55.8. Error and Notice Message Fields
---
...
Code: the SQLSTATE code for the error (see [Appendix A](</VIII. Appendixes/errcodes-appendix.md>)). Not localizable. Always present.
