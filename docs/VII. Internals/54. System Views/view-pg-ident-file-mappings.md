---
title: 54.10. `pg_ident_file_mappings`
---
...
The view `pg_ident_file_mappings` provides a summary of the contents of the client user name mapping configuration file, [`pg_ident.conf`](</III. Server Administration/21. Client Authentication/auth-username-maps.md>). A row appears in this view for each non-empty, non-comment line in the file, with annotations indicating whether the map could be applied successfully.
