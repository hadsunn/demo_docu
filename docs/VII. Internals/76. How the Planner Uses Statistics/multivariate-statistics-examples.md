---
title: 76.2. Multivariate Statistics Examples
---
...
As explained in [Section 14.2](</II. The SQL Language/14. Performance Tips/planner-stats.md>), the planner can determine cardinality of `t` using the number of pages and rows obtained from `pg_class`:
