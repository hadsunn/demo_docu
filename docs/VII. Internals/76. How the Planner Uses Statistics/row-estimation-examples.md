---
title: 76.1. Row Estimation Examples
---
...
How the planner determines the cardinality of `tenk1` is covered in [Section 14.2](</II. The SQL Language/14. Performance Tips/planner-stats.md>), but is repeated here for completeness. The number of pages and rows is looked up in `pg_class`:
