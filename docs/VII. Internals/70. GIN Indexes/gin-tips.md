...
[gin_pending_list_limit](runtime-config-client.html#GUC-GIN-PENDING-LIST-LIMIT)
...
[gin_fuzzy_search_limit](runtime-config-client.html#GUC-GIN-FUZZY-SEARCH-LIMIT)
