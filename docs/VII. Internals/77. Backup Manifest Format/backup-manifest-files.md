---
title: 77.2. Backup Manifest File Object
---
...
The last modification time of the file as reported by the server at the time of the backup. Unlike the other fields stored in the backup, this field is not used by [pg_verifybackup](</VI. Reference/II. PostgreSQL Client Applications/app-pgverifybackup.md>). It is included only for informational purposes.
