...
if the command was rewritten into another kind of command (e.g., `UPDATE` became an `INSERT`) by a [rule](</V. Server Programming/41. The Rule System/41. The Rule System.md>).
