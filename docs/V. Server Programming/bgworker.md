---
title: Chapter 48. Background Worker Processes
---
...
The maximum number of registered background workers is limited by [max_worker_processes](runtime-config-resource.html#GUC-MAX-WORKER-PROCESSES).
