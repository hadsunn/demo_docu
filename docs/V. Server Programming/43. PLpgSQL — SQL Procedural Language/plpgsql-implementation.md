---
title: 43.11. PL/pgSQL under the Hood
---
...
Alternatively you can qualify ambiguous references to make them clear. In the above example, `src.foo` would be an unambiguous reference to the table column. To create an unambiguous reference to a variable, declare it in a labeled block and use the block's label (see [Section 43.2](</V. Server Programming/43. PLpgSQL — SQL Procedural Language/plpgsql-structure.md>)). For example,
