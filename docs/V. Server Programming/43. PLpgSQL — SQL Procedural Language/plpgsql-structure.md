---
title: 43.2. Structure of PL/pgSQL
---
...
Functions written in PL/pgSQL are defined to the server by executing [CREATE FUNCTION](</VI. Reference/I. SQL Commands/sql-createfunction.md>) commands. Such a command would normally look like, say,
...
It is important not to confuse the use of `BEGIN`/`END` for grouping statements in PL/pgSQL with the similarly-named SQL commands for transaction control. PL/pgSQL's `BEGIN`/`END` are only for grouping; they do not start or end a transaction. See [Section 43.8](</V. Server Programming/43. PLpgSQL — SQL Procedural Language/plpgsql-transactions.md>).
