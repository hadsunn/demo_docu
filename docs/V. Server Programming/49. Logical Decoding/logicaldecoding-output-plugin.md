---
title: 49.6. Logical Decoding Output Plugins
---
...
An example output plugin can be found in the [`contrib/test_decoding`](</VIII. Appendixes/F. Additional Supplied Modules and Extensions/test-decoding.md>) subdirectory of the PostgreSQL source tree.
