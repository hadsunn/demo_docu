---
title: 44.9. Explicit Subtransactions in PL/Tcl
---
...
Recovering from errors caused by database access as described in [Section 44.8](</V. Server Programming/44. PLTcl — Tcl Procedural Language/pltcl-error-handling.md>) can lead to an undesirable situation where some operations succeed before one of them fails, and after recovering from that error the data is left in an inconsistent state. PL/Tcl offers a solution to this problem in the form of explicit subtransactions.
