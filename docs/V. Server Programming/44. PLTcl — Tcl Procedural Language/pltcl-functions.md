---
title: 44.2. PL/Tcl Functions and Arguments
---
...
To create a function in the PL/Tcl language, use the standard [CREATE FUNCTION](</VI. Reference/I. SQL Commands/sql-createfunction.md>) syntax:
