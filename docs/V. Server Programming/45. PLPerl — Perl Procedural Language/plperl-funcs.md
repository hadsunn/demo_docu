---
title: 45.1. PL/Perl Functions and Arguments
---
...
To create a function in the PL/Perl language, use the standard [CREATE FUNCTION](</VI. Reference/I. SQL Commands/sql-createfunction.md>) syntax:
...
PL/Perl also supports anonymous code blocks called with the [DO](</VI. Reference/I. SQL Commands/sql-do.md>) statement:
