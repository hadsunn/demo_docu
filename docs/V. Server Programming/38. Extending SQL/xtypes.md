---
title: 38.13. User-Defined Types
---
...
For further details see the description of the [CREATE TYPE](</VI. Reference/I. SQL Commands/sql-createtype.md>) command.

### 38.13.1. TOAST Considerations #

If the values of your data type vary in size (in internal form), it's usually desirable to make the data type TOAST-able (see [Section 73.2](</VII. Internals/73. Database Physical Storage/storage-toast.md>)). You should do this even if the values are always too small to be compressed or stored externally, because TOAST can save space on small data too, by reducing header overhead.
