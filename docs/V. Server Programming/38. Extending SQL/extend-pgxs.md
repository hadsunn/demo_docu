---
title: 38.18. Extension Building Infrastructure
---
...
`TAP_TESTS` enables the use of TAP tests. Data from each run is present in a subdirectory named `tmp_check/`. See also [Section 33.4](</III. Server Administration/33. Regression Tests/regress-tap.md>) for more details.
