---
title: Chapter 50. Replication Progress Tracking
---
...
Replication origins are intended to make it easier to implement logical replication solutions on top of [logical decoding](</V. Server Programming/49. Logical Decoding/49. Logical Decoding.md>). They provide a solution to two common problems:
...
Replication origins can be created using the function [`pg_replication_origin_create(<)`]>) system catalog.
