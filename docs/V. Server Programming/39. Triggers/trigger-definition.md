---
title: 39.1. Overview of Trigger Behavior
---
...
Once a suitable trigger function has been created, the trigger is established with [CREATE TRIGGER](</VI. Reference/I. SQL Commands/sql-createtrigger.md>). The same trigger function can be used for multiple triggers.
