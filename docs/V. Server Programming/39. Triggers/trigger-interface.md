...
To allow queries issued through SPI to reference transition tables, see [SPI_register_trigger_data](</V. Server Programming/47. Server Programming Interface/47.1. Interface Functions/spi-spi-register-trigger-data.md>).
