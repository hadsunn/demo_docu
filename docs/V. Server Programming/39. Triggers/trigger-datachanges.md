...
Further information about data visibility rules can be found in [Section 47.5](</V. Server Programming/47. Server Programming Interface/spi-visibility.md>) contains a demonstration of these rules.
