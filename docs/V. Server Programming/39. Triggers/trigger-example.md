---
title: 39.4. A Complete Trigger Example
---
...
There are more complex examples in `src/test/regress/regress.c` and in [spi](</VIII. Appendixes/F. Additional Supplied Modules and Extensions/contrib-spi.md>).
