...
Set the new WAL segment size, in megabytes. The value must be set to a power of 2 between 1 and 1024 (megabytes). See the same option of [initdb](</VI. Reference/III. PostgreSQL Server Applications/app-initdb.md>) for more information.
...
[pg_controldata](</VI. Reference/III. PostgreSQL Server Applications/app-pgcontroldata.md>)
