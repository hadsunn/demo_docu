...
Use [`RELEASE SAVEPOINT`](</VI. Reference/I. SQL Commands/sql-release-savepoint.md>) to destroy a savepoint without discarding the effects of commands executed after it was established.
