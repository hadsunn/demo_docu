...
After a sequence is created, you use the functions `nextval`, `currval`, and `setval` to operate on the sequence. These functions are documented in [Section 9.17](</II. The SQL Language/9. Functions and Operators/functions-sequence.md>).
...
[ALTER SEQUENCE](</VI. Reference/I. SQL Commands/sql-altersequence.md>)
