...
See the description of the [`GRANT`](</VI. Reference/I. SQL Commands/sql-grant.md>) command for the meaning of the privilege types.
...
The compatibility notes of the [`GRANT`](</VI. Reference/I. SQL Commands/sql-grant.md>) command apply analogously to `REVOKE`. The keyword `RESTRICT` or `CASCADE` is required according to the standard, but PostgreSQL assumes `RESTRICT` by default.
