...
This form changes the sequence from unlogged to logged or vice-versa (see [CREATE SEQUENCE](</VI. Reference/I. SQL Commands/sql-createsequence.md>)). It cannot be applied to a temporary sequence.
