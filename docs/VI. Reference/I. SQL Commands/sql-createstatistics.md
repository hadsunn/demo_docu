...
The name (optionally schema-qualified) of the table containing the column(s) the statistics are computed on; see [ANALYZE](</VI. Reference/I. SQL Commands/sql-analyze.md>) for an explanation of the handling of inheritance and partitions.
