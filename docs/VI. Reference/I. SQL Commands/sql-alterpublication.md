...
The fourth variant of this command listed in the synopsis can change all of the publication properties specified in [CREATE PUBLICATION](</VI. Reference/I. SQL Commands/sql-createpublication.md>). Properties not mentioned in the command retain their previous settings.
...
Optionally, a column list can be specified. See [CREATE PUBLICATION](</VI. Reference/I. SQL Commands/sql-createpublication.md>) for details of potential problems when altering column lists.
...
This clause alters publication parameters originally set by [CREATE PUBLICATION](</VI. Reference/I. SQL Commands/sql-createpublication.md>). See there for more information.
...
[CREATE PUBLICATION](</VI. Reference/I. SQL Commands/sql-createpublication.md>)
