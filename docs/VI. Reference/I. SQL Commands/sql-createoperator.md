...
The other clauses specify optional operator optimization clauses. Their meaning is detailed in [Section 38.15](</V. Server Programming/38. Extending SQL/xoper-optimization.md>).
...
Refer to [Section 38.14](</V. Server Programming/38. Extending SQL/xoper.md>) for further information.
...
Use [`DROP OPERATOR`](</VI. Reference/I. SQL Commands/sql-dropoperator.md>) to modify operators in a database.
...
[ALTER OPERATOR](</VI. Reference/I. SQL Commands/sql-alteroperator.md>)
