...
The following example command defines a GiST index operator class for the data type `_int4` (array of `int4`). See the [intarray](</VIII. Appendixes/F. Additional Supplied Modules and Extensions/intarray.md>) module for the complete example.
