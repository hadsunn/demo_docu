...
The function `pg_notification_queue_usage` returns the fraction of the queue that is currently occupied by pending notifications. See [Section 9.26](</II. The SQL Language/9. Functions and Operators/functions-info.md>) for more information.
