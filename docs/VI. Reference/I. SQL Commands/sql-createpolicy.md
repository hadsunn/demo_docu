...
`UPDATE` / `MERGE ... THEN UPDATE` | Existing & new rows [[a]](</VI. Reference/I. SQL Commands/sql-createpolicy.md#ftnrls-select-priv>) | — | Existing row | New row | —  
`DELETE` | Existing row [[a]](</VI. Reference/I. SQL Commands/sql-createpolicy.md#ftnrls-select-priv>) | — | — | — | Existing row  
...
Additional discussion and practical examples can be found in [Section 5.8](</II. The SQL Language/5. Data Definition/ddl-rowsecurity.md>).
...
[ALTER POLICY](</VI. Reference/I. SQL Commands/sql-alterpolicy.md>)
