...
A [`SELECT`](</VI. Reference/I. SQL Commands/sql-select.md>) command whose results are to be copied. Note that parentheses are required around the query.
