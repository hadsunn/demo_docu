...
Use the `CONCURRENTLY` option. See [REINDEX](</VI. Reference/I. SQL Commands/sql-reindex.md>), where all the caveats of this option are explained in detail.
...
In case of difficulty, see [REINDEX](</VI. Reference/I. SQL Commands/sql-reindex.md>) for discussions of potential problems and error messages. The database server must be running at the targeted host. Also, any default connection settings and environment variables used by the libpq front-end library will apply.
...
[REINDEX](</VI. Reference/I. SQL Commands/sql-reindex.md>)
