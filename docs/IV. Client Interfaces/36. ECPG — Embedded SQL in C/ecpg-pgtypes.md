...
The date type in C enables your programs to deal with data of the SQL type date. See [Section 8.5](</II. The SQL Language/8. Data Types/datatype-datetime.md>) for the equivalent type in the PostgreSQL server.
...
The timestamp type in C enables your programs to deal with data of the SQL type timestamp. See [Section 8.5](</II. The SQL Language/8. Data Types/datatype-datetime.md>) for the equivalent type in the PostgreSQL server.
...
The interval type in C enables your programs to deal with data of the SQL type interval. See [Section 8.5](</II. The SQL Language/8. Data Types/datatype-datetime.md>) for the equivalent type in the PostgreSQL server.
