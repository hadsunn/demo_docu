---
title: 34.10. Functions Associated with the `COPY` Command
---
...
0 indicates the overall copy format is textual (rows separated by newlines, columns separated by separator characters, etc.). 1 indicates the overall copy format is binary. See [COPY](</VI. Reference/I. SQL Commands/sql-copy.md>) for more information.
