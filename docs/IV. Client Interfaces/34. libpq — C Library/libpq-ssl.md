...
PostgreSQL has native support for using SSL connections to encrypt client/server communications using TLS protocols for increased security. See [Section 19.9](</III. Server Administration/19. Server Setup and Operation/ssl-tcp.md>) for details about the server-side SSL functionality.
