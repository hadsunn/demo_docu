...
Where interoperability with other systems is a concern, for some data types, it may be necessary to use data type formatting functions (such as those in [Section 9.8](</II. The SQL Language/9. Functions and Operators/functions-formatting.md>)) explicitly to produce the standard mappings.
