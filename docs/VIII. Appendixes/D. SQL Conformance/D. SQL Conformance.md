...
[D.1. Supported Features](</VIII. Appendixes/D. SQL Conformance/features-sql-standard.md>)
[D.2. Unsupported Features](</VIII. Appendixes/D. SQL Conformance/unsupported-features-sql-standard.md>)
[D.3. XML Limits and Conformance to SQL/XML](</VIII. Appendixes/D. SQL Conformance/xml-limits-conformance.md>)
    

[D.3.1. Queries Are Restricted to XPath 1.0](</VIII. Appendixes/D. SQL Conformance/xml-limits-conformance.md#d31-queries-are-restricted-to-xpath-10>)


[D.3.2. Incidental Limits of the Implementation](</VIII. Appendixes/D. SQL Conformance/xml-limits-conformance.md#d32-incidental-limits-of-the-implementation>)
