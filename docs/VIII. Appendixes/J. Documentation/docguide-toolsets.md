...
[J.2.1. Installation on Fedora, RHEL, and Derivatives](</VIII. Appendixes/J. Documentation/docguide-toolsets.md#j21-installation-on-fedora-rhel-and-derivatives>)


[J.2.2. Installation on FreeBSD](</VIII. Appendixes/J. Documentation/docguide-toolsets.md#j22-installation-on-freebsd>)


[J.2.3. Debian Packages](</VIII. Appendixes/J. Documentation/docguide-toolsets.md#j23-debian-packages>)


[J.2.4. macOS](</VIII. Appendixes/J. Documentation/docguide-toolsets.md#j24-macos>)


[J.2.5. Detection by `configure`](</VIII. Appendixes/J. Documentation/docguide-toolsets.md#j25-detection-by-configure>)
...
If you prefer to build PostgreSQL using Meson, instead run `meson setup` as described in [Section 17.4](</III. Server Administration/17. Installation from Source Code/install-meson.md>).
