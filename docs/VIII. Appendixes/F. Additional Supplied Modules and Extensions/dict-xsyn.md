---
title: F.14. dict_xsyn — example synonym full-text search dictionary
---
...
[F.14.1. Configuration](</VIII. Appendixes/F. Additional Supplied Modules and Extensions/dict-xsyn.md#f141-configuration>)


[F.14.2. Usage](</VIII. Appendixes/F. Additional Supplied Modules and Extensions/dict-xsyn.md#f142-usage>)
...
Real-world usage will involve including it in a text search configuration as described in [Chapter 12](</II. The SQL Language/12. Full Text Search/12. Full Text Search.md>). That might look like this:
