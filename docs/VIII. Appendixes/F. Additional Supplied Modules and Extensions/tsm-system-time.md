...
[F.47.1. Examples](</VIII. Appendixes/F. Additional Supplied Modules and Extensions/tsm-system-time.md#f471-examples>)



The `tsm_system_time` module provides the table sampling method `SYSTEM_TIME`, which can be used in the `TABLESAMPLE` clause of a [`SELECT`](</VI. Reference/I. SQL Commands/sql-select.md>) command.
