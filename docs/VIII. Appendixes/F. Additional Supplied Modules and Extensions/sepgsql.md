...
[F.40.1. Overview](</VIII. Appendixes/F. Additional Supplied Modules and Extensions/sepgsql.md#f401-overview>)


[F.40.2. Installation](</VIII. Appendixes/F. Additional Supplied Modules and Extensions/sepgsql.md#f402-installation>)


[F.40.3. Regression Tests](</VIII. Appendixes/F. Additional Supplied Modules and Extensions/sepgsql.md#f403-regression-tests>)


[F.40.4. GUC Parameters](</VIII. Appendixes/F. Additional Supplied Modules and Extensions/sepgsql.md#f404-guc-parameters>)


[F.40.5. Features](</VIII. Appendixes/F. Additional Supplied Modules and Extensions/sepgsql.md#f405-features>)


[F.40.6. Sepgsql Functions](</VIII. Appendixes/F. Additional Supplied Modules and Extensions/sepgsql.md#f406-sepgsql-functions>)


[F.40.7. Limitations](</VIII. Appendixes/F. Additional Supplied Modules and Extensions/sepgsql.md#f407-limitations>)


[F.40.8. External Resources](</VIII. Appendixes/F. Additional Supplied Modules and Extensions/sepgsql.md#f408-external-resources>)


[F.40.9. Author](</VIII. Appendixes/F. Additional Supplied Modules and Extensions/sepgsql.md#f409-author>)
...
The current implementation has significant limitations, and does not enforce mandatory access control for all actions. See [Section F.40.7](sepgsql.html#SEPGSQL-LIMITATIONS "F.40.7. Limitations").
...
The [`SECURITY LABEL`](</VI. Reference/I. SQL Commands/sql-security-label.md>) statement allows assignment of a security label to a database object.
...
First, set up `sepgsql` in a working database according to the instructions in [Section F.40.2](sepgsql.html#SEPGSQL-INSTALLATION "F.40.2. Installation"). Note that the current operating system user must be able to connect to the database as superuser without password authentication.
...
See [Section F.40.8](sepgsql.html#SEPGSQL-RESOURCES "F.40.8. External Resources") for details on adjusting your working domain, if necessary.
...
Creating a new database object requires `create` permission. SELinux will grant or deny this permission based on the client's security label and the proposed security label for the new object. In some cases, additional privileges are required:
  ...
  * [`CREATE DATABASE`](</VI. Reference/I. SQL Commands/sql-createdatabase.md>) additionally requires `getattr` permission for the source or template database.
...
We reject the [`LOAD`](</VI. Reference/I. SQL Commands/sql-load.md>) command across the board, because any module loaded could easily circumvent security policy enforcement.
