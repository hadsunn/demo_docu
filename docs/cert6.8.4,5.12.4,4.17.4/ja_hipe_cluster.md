...
<p><strong>Руководство по настройке. Часть 11.<br />
Высокопроизводительный кластер.<br />
Компонент «ja_Hipe_Cluster»</strong></p></td>
</tr>
<tr>
<td colspan="2" style="text-align: center;"><strong>643.72410666.00067-07 98 01-11</strong></td>
</tr>
<tr>
...
<tr>
<td colspan="2" style="text-align: center;">Листов 106</td>
</tr>
<tr>
<td style="text-align: center;"></td>
<td style="text-align: center;"></td>
...
<thead>
<tr>
<th style="text-align: center;">Раздел 1, в котором приведены назначение и функции СУБД «Jatoba» и требования к среде функционирования СУБД;Раздел 2 содержит описание использования компонента;Раздел 3 содержит описание установки и настройки компонента;Раздел 4 описывает функциональные возможности компонента;Раздел 5 описывает обновление и удаление компонента;В Приложении Приложение 1 приведен пример установки СУБД «Jatoba» из локального репозитория для ОС Ubuntu 20.04;В Приложении Приложение 2 приведена инструкция по восстановлению данных при помощи компонента pg_ProBackup;В Приложении Приложение 3 приведена инструкция по настройке SSL соединения для ja_Hipe_Cluster. <img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/ja_hipe_cluster/media/image1.png" style="width:0.25in;height:0.25in" /></th>
...
[1.1. Функциональные возможности [6](#функциональные-возможности)](#функциональные-возможности)

[1.2. Условия применения [7](#таблицы-могут-быть-распределены-между-рабочими-узлами-кластера-субд-jatoba-для-объединения-их-ресурсов-процессоров-памяти-и-хранилищсправочные-таблицы-реплицируются-на-все-узлы-для-соединений-и-внешних-ключей-из-распределенных-таблиц-и-максимальной-производительности-чтениямеханизм-распределенных-запросов-маршрутизирует-и-распараллеливает-select-ddl-и-другие-операции-над-распределенными-таблицами-в-кластересправочные-таблицы-используются-для-хранения-данных-к-которым-необходимо-часто-обращаться-нескольким-узлам-кластераколоночное-хранилище-сжимает-данные-ускоряет-сканирование-и-поддерживает-быстрое-отображение-как-в-обычных-так-и-в-распределенных-таблицахзапрос-с-любого-узла-позволяет-использовать-все-возможности-кластера-для-распределенных-запросов.условия-применения)](#таблицы-могут-быть-распределены-между-рабочими-узлами-кластера-субд-jatoba-для-объединения-их-ресурсов-процессоров-памяти-и-хранилищсправочные-таблицы-реплицируются-на-все-узлы-для-соединений-и-внешних-ключей-из-распределенных-таблиц-и-максимальной-производительности-чтениямеханизм-распределенных-запросов-маршрутизирует-и-распараллеливает-select-ddl-и-другие-операции-над-распределенными-таблицами-в-кластересправочные-таблицы-используются-для-хранения-данных-к-которым-необходимо-часто-обращаться-нескольким-узлам-кластераколоночное-хранилище-сжимает-данные-ускоряет-сканирование-и-поддерживает-быстрое-отображение-как-в-обычных-так-и-в-распределенных-таблицахзапрос-с-любого-узла-позволяет-использовать-все-возможности-кластера-для-распределенных-запросов.условия-применения)

[1.3. Требования к среде функционирования [7](#требования-к-среде-функционирования)](#требования-к-среде-функционирования)

[2. Использование [8](#использование)](#использование)

[2.1. Общая схема работы [8](#общая-схема-работы)](#общая-схема-работы)

[2.1.1. Узлы [9](#узлы)](#узлы)

[2.1.2. Координатор и рабочие узлы [9](#координатор-и-рабочие-узлы)](#координатор-и-рабочие-узлы)

[2.1.3. Распределенные данные [9](#распределенные-данные)](#распределенные-данные)

[2.1.4. Структура таблицы метаданных pg_dist_shard [11](#структура-таблицы-метаданных-pg_dist_shard)](#структура-таблицы-метаданных-pg_dist_shard)

[2.1.5. Размещение сегментов [12](#размещение-сегментов)](#размещение-сегментов)

[2.1.6. Совместное размещение [13](#совместное-размещение)](#совместное-размещение)

[2.1.7. Параллелизм [13](#параллелизм)](#параллелизм)

[2.1.8. Выполнение запроса [13](#выполнение-запроса)](#выполнение-запроса)

[2.1.9. Добавление координатора [15](#добавление-координатора)](#добавление-координатора)

[2.1.10. Обработка аварийных ситуаций [15](#обработка-аварийных-ситуаций)](#обработка-аварийных-ситуаций)

[3. Установка и настройка компонента [18](#компонент-ja_hipe_cluster-на-основе-обновленной-таблицы-pg_dist_node-выполняет-перенаправление-обращений-клиентов-на-новый-узел.установка-и-настройка-компонента)](#компонент-ja_hipe_cluster-на-основе-обновленной-таблицы-pg_dist_node-выполняет-перенаправление-обращений-клиентов-на-новый-узел.установка-и-настройка-компонента)

[3.1. Установка компонента [18](#установка-компонента)](#установка-компонента)

[3.2. Настройка сервера «Coordinator» [19](#настройка-сервера-coordinator)](#настройка-сервера-coordinator)

[3.2.1. Редактирование конфигурационного файла «postgresql.conf» [19](#редактирование-конфигурационного-файла-postgresql.conf)](#редактирование-конфигурационного-файла-postgresql.conf)

[3.2.2. Редактирование конфигурационного файла «pg_hba.conf» [20](#редактирование-конфигурационного-файла-pg_hba.conf)](#редактирование-конфигурационного-файла-pg_hba.conf)

[3.2.3. Создание БД «citus_db» [22](#создание-бд-citus_db)](#создание-бд-citus_db)

[3.2.4. Установка расширения «citus» [22](#установка-расширения-citus)](#установка-расширения-citus)

[3.3. Настройка сервера «Node1» [23](#настройка-сервера-node1)](#настройка-сервера-node1)

[3.4. Настройка сервера «Node2» [24](#настройка-сервера-node2)](#настройка-сервера-node2)

[3.5. Настройка кластера [25](#настройка-кластера)](#настройка-кластера)

[3.5.1. Добавление информации об узле координатора [25](#добавление-информации-об-узле-координатора)](#добавление-информации-об-узле-координатора)

[3.5.2. Добавление узлов кластера [27](#добавление-узлов-кластера)](#добавление-узлов-кластера)

[3.5.3. Использование режима preferred для запросов только на чтение к узлам кластера [28](#использование-режима-preferred-для-запросов-только-на-чтение-к-узлам-кластера)](#использование-режима-preferred-для-запросов-только-на-чтение-к-узлам-кластера)

[4. Функции компонента [33](#функции-компонента)](#функции-компонента)

[4.1. Создание и модификация распределенных объектов [33](#создание-и-модификация-распределенных-объектов)](#создание-и-модификация-распределенных-объектов)

[4.2. Справочные таблицы [34](#справочные-таблицы)](#справочные-таблицы)

[4.3. Распределение данных координатора [35](#распределение-данных-координатора)](#распределение-данных-координатора)

[4.4. Совместное размещение таблиц [36](#совместное-размещение-таблиц)](#совместное-размещение-таблиц)

[4.4.1. Создание совместно размещенных таблиц [36](#создание-совместно-размещенных-таблиц)](#создание-совместно-размещенных-таблиц)

[4.4.2. Выбор столбца распределения [38](#выбор-столбца-распределения)](#выбор-столбца-распределения)

[4.5. Удаление таблиц [42](#удаление-таблиц)](#удаление-таблиц)

[4.6. Изменение таблиц [42](#изменение-таблиц)](#изменение-таблиц)

[4.7. Добавление / изменение столбцов [42](#добавление-изменение-столбцов)](#добавление-изменение-столбцов)

[4.8. Добавление/удаление ограничений [43](#добавлениеудаление-ограничений)](#добавлениеудаление-ограничений)

[4.9. Использование ограничений “NOT VALID” [46](#использование-ограничений-not-valid)](#использование-ограничений-not-valid)

[4.10. Добавление / удаление индексов [47](#добавление-удаление-индексов)](#добавление-удаление-индексов)

[4.11. Типы и функции [48](#типы-и-функции)](#типы-и-функции)

[4.12. Служебные функции ja_Hipe_Cluster [50](#использовать-citus.create_object_propagation-для-возвращения-к-старому-поведению-распространения-объектов.-может-возникнуть-некоторое-несоответствие-между-тем-какие-объекты-базы-данных-существуют-на-разных-узлахиспользовать-citus.multi_shard_modify_mode-для-отключения-параллелизма-для-каждого-узла.-загрузка-данных-в-одной-транзакции-может-быть-медленнее.служебные-функции-ja_hipe_cluster)](#использовать-citus.create_object_propagation-для-возвращения-к-старому-поведению-распространения-объектов.-может-возникнуть-некоторое-несоответствие-между-тем-какие-объекты-базы-данных-существуют-на-разных-узлахиспользовать-citus.multi_shard_modify_mode-для-отключения-параллелизма-для-каждого-узла.-загрузка-данных-в-одной-транзакции-может-быть-медленнее.служебные-функции-ja_hipe_cluster)

[4.12.1. Таблица и сегмент DDL [50](#таблица-и-сегмент-ddl)](#таблица-и-сегмент-ddl)

[4.12.2. Метаданные / Информация о конфигурации [63](#метаданные-информация-о-конфигурации)](#метаданные-информация-о-конфигурации)

[4.12.3. Функции управления кластером и восстановления [78](#функции-управления-кластером-и-восстановления)](#функции-управления-кластером-и-восстановления)

[5. Обновление и удаление компонента [89](#обновление-и-удаление-компонента)](#обновление-и-удаление-компонента)

[Приложение 1 [90](#_Toc215497535)](#_Toc215497535)

[Пример установки СУБД «Jatoba» из локального репозитория для ОС Ubuntu 20.04 [90](#_Toc215497536)](#_Toc215497536)

[Приложение 2 [96](#_Toc215497537)](#_Toc215497537)

[Восстановление данных при помощи компонента pg_ProBackup [96](#_Toc215497538)](#_Toc215497538)

[Приложение 3 [100](#_Toc215497539)](#_Toc215497539)

[Настройка SSL соединения для ja_Hipe_Cluster [100](#_Toc215497540)](#_Toc215497540)

[Термины и определения [104](#_Toc215497541)](#_Toc215497541)

[Перечень сокращений [105](#_Toc215497542)](#_Toc215497542)
...
![](../docs/assets/images/cert6.8.4,5.12.4,4.17.4/ja_hipe_cluster/media/image8.emf)
...
<thead>
<tr>
<th style="text-align: center;"><img src="../docs/assets/images/cert6.8.4,5.12.4,4.17.4/ja_hipe_cluster/media/image1.png" style="width:0.25in;height:0.25in" /></th>
<th><p>Данная функция работает независимо от pg_stat_statements_reset().</p>
<p>Для сброса всей статистики необходимо вызвать обе функции.</p></th>
</tr>
</thead>
<tbody>
</tbody>
