...
A data type `tsvector` is provided for storing preprocessed documents, along with a type `tsquery` for representing processed queries ([Section 8.11](</II. The SQL Language/8. Data Types/datatype-textsearch.md>)).
