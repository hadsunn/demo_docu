...
Policies are created using the [CREATE POLICY](</VI. Reference/I. SQL Commands/sql-createpolicy.md>) command.
...
For additional details see [CREATE POLICY](</VI. Reference/I. SQL Commands/sql-createpolicy.md>).
