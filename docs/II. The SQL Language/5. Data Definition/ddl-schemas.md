...
To create a schema, use the [CREATE SCHEMA](</VI. Reference/I. SQL Commands/sql-createschema.md>) command. Give the schema a name of your choice. For example:
...
See also [Section 9.26](</II. The SQL Language/9. Functions and Operators/functions-info.md>) for other ways to manipulate the schema search path.
