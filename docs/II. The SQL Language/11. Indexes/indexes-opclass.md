...
[psql](</VI. Reference/II. PostgreSQL Client Applications/app-psql.md>) has commands `\dAc`, `\dAf`, and `\dAo`, which provide slightly more sophisticated versions of these queries.
