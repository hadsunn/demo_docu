...
Refer to [Section 4.1.2.1](<sql-syntax-lexical#SQL-SYNTAX-STRINGS>) for information about available operators and functions.
...
(1) |  The `char_length` function is discussed in [Section 9.4](</II. The SQL Language/9. Functions and Operators/functions-string.md>).  
