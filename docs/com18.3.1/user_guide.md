...
<thead>
<tr>
<th>УТВЕРЖДЕН 643.72410666.00067-08 96 01-ЛУ</th>
</tr>
</thead>
<tbody>
<tr>
...
<p><strong>643.72410666.00067-08 96 01</strong></p>
</blockquote></td>
</tr>
<tr>
<td style="text-align: center;"><blockquote>
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image1.png" style="width:0.25208in;height:0.25208in" /><img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25277in;height:0.25208in" />Степени важности примечаний, применяемые в документе:
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image1.png" style="width:0.25138in;height:0.25139in" /> **Важная информация**
>
> Для сертифицированной версии СУБД «Jatoba» поддерживается работа только на ОС, указанных в формуляре на поставку!
>
> **СОДЕРЖАНИЕ**

1.  [Общие сведения о СУБД «Jatoba» 7](#общие-сведения-о-субд-jatoba)

    1.  [Назначение СУБД «Jatoba» 7](#назначение-субд-jatoba)

    2.  [Функции СУБД «Jatoba» 7](#функции-субд-jatoba)

    3.  [Требования к среде функционирования СУБД «Jatoba» 7](#требования-к-среде-функционирования-субд-jatoba)

2.  [Порядок подключения к СУБД «Jatoba» 10](#порядок-подключения-к-субд-jatoba)

    1.  [Порядок подключения к СУБД «Jatoba» под управлением ОС Windows Server 10](#порядок-подключения-к-субд-jatoba-под-управлением-ос-windows-server)

    2.  [Порядок подключения к СУБД «Jatoba» под управлением ОС GNU/Linux 11](#порядок-подключения-к-субд-jatoba-под-управлением-ос-gnulinux)

3.  [Описание операций СУБД «Jatoba» 13](#описание-операций-субд-jatoba)

4.  [Синтаксис SQL 14](#синтаксис-sql)

    1.  [Лексическая структура 14](#лексическая-структура)

        1.  [Идентификаторы и ключевые слова 15](#идентификаторы-и-ключевые-слова)

        2.  [Константы 17](#_bookmark12)

        3.  [Операторы 22](#операторы)

        4.  [Специальные знаки 22](#специальные-знаки)

        5.  [Комментарии 23](#комментарии)

        6.  [Приоритеты операторов 24](#приоритеты-операторов)

    2.  [Выражения значения 25](#выражения-значения)

        1.  [Ссылки на столбцы 26](#ссылки-на-столбцы)

        2.  [Позиционные параметры 26](#позиционные-параметры)

        3.  [Индексы элементов 26](#индексы-элементов)

        4.  [Выбор поля 27](#выбор-поля)

        5.  [Применение оператора 27](#применение-оператора)

        6.  [Вызовы функций 28](#_bookmark25)

        7.  [Агрегатные выражения 28](#_bookmark26)

        8.  [Вызовы оконных функций 32](#вызовы-оконных-функций)

        9.  [Приведения типов 36](#приведения-типов)

        10. [Применение правил сортировки 37](#применение-правил-сортировки)

        11. [Скалярные подзапросы 38](#скалярные-подзапросы)

        12. [Конструкторы массивов 39](#конструкторы-массивов)

        13. [Конструкторы табличных строк 41](#конструкторы-табличных-строк)

        14. [Правила вычисления выражений 42](#_bookmark33)

    3.  [Вызов функций 44](#вызов-функций)

        1.  [Позиционная передача 45](#позиционная-передача)

        2.  [Именная передача 46](#именная-передача)

        3.  [Смешанная передача 47](#смешанная-передача)

5.  [Типы данных 48](#типы-данных)

    1.  [Числовые типы 50](#числовые-типы)

        1.  [Целочисленные типы 50](#целочисленные-типы)

        2.  [Числа с произвольной точностью 51](#числа-с-произвольной-точностью)

        3.  [Типы с плавающей точкой 53](#типы-с-плавающей-точкой)

        4.  [Последовательные типы 55](#последовательные-типы)

    2.  [Денежные типы 57](#денежные-типы)

    3.  [Символьные типы 58](#символьные-типы)

    4.  [Двоичные типы данных 60](#двоичные-типы-данных)

        1.  [Шестнадцатеричный формат bytea 61](#шестнадцатеричный-формат-bytea)

        2.  [Формат спецпоследовательностей bytea 61](#формат-спецпоследовательностей-bytea)

    5.  [Типы даты/времени 63](#типы-датывремени)

        1.  [Ввод даты/времени 65](#ввод-датывремени)

        2.  [Вывод даты/времени 70](#_bookmark60)

        3.  [Часовые пояса 71](#часовые-пояса)

        4.  [Ввод интервалов 73](#ввод-интервалов)

        5.  [Вывод интервалов 76](#вывод-интервалов)

    6.  [Логический тип 77](#логический-тип)

    7.  [Типы перечислений 78](#типы-перечислений)

        1.  [Объявление перечислений 78](#объявление-перечислений)

        2.  [Порядок 79](#порядок)

        3.  [Безопасность типа 80](#безопасность-типа)

        4.  [Тонкости реализации 81](#тонкости-реализации)

    8.  [Геометрические типы 81](#геометрические-типы)

        1.  [Точки 82](#точки)

        2.  [Прямые 82](#прямые)

        3.  [Отрезки 82](#отрезки)

        4.  [Прямоугольники 83](#_bookmark80)

        5.  [Пути 83](#_bookmark81)

        6.  [Многоугольники 84](#многоугольники)

        7.  [Окружности 84](#окружности)

    9.  [Типы, описывающие сетевые адреса 84](#типы-описывающие-сетевые-адреса)

        1.  [inet 85](#inet)

        2.  [cidr 85](#cidr)

        3.  [Различия inet и cidr 86](#различия-inet-и-cidr)

        4.  [macaddr 86](#macaddr)

        5.  [macaddr8 87](#macaddr8)

    10. [Битовые строки 88](#битовые-строки)

    11. [Типы, предназначенные для текстового поиска 89](#_bookmark93)

        1.  [tsvector 89](#_bookmark94)

        2.  [tsquery 91](#tsquery)

    12. [Тип UUID 92](#тип-uuid)

    13. [Тип XML 93](#тип-xml)

        1.  [Создание XML-значений 93](#создание-xml-значений)

        2.  [Обработка кодировки 95](#обработка-кодировки)

        3.  [Обращение к XML-значениям 96](#обращение-к-xml-значениям)

    14. [Типы JSON 96](#типы-json)

        1.  [Проектирование документов JSON 99](#проектирование-документов-json)

        2.  [Проверки на вхождение и существование jsonb 99](#проверки-на-вхождение-и-существование-jsonb)

        3.  [Индексация jsonb 102](#индексация-jsonb)

        4.  [Обращение по индексу к элементам jsonb 106](#обращение-по-индексу-к-элементам-jsonb)

        5.  [Трансформации 109](#трансформации)

        6.  [Тип jsonpath 109](#тип-jsonpath)

    15. [Массивы 112](#массивы)

        1.  [Объявления типов массивов 112](#объявления-типов-массивов)

        2.  [Ввод значения массива 113](#ввод-значения-массива)

        3.  [Обращение к массивам 115](#обращение-к-массивам)

        4.  [Изменение массивов 118](#_bookmark113)

        5.  [Поиск значений в массивах 122](#поиск-значений-в-массивах)

        6.  [Синтаксис вводимых и выводимых значений массива 124](#_bookmark115)

    16. [Составные типы 126](#составные-типы)

        1.  [Объявление составных типов 126](#объявление-составных-типов)

        2.  [Конструирование составных значений 127](#_bookmark118)

        3.  [Обращение к составным типам 128](#обращение-к-составным-типам)

        4.  [Изменение составных типов 129](#изменение-составных-типов)

        5.  [Использование составных типов в запросах 130](#использование-составных-типов-в-запросах)

        6.  [Синтаксис вводимых и выводимых значений составного типа 134](#синтаксис-вводимых-и-выводимых-значений-составного-типа)

    17. [Диапазонные типы 135](#диапазонные-типы)

        1.  [Встроенные диапазонные и мультидиапазонные типы 136](#встроенные-диапазонные-и-мультидиапазонные-типы)

        2.  [Включение и исключение границ 136](#включение-и-исключение-границ)

        3.  [Неограниченные (бесконечные) диапазоны 136](#неограниченные-бесконечные-диапазоны)

        4.  [Ввод/вывод диапазонов 137](#вводвывод-диапазонов)

        5.  [Конструирование диапазонов и мультидиапазонов 138](#конструирование-диапазонов-и-мультидиапазонов)

        6.  [Типы дискретных диапазонов 139](#типы-дискретных-диапазонов)

        7.  [Определение новых диапазонных типов 140](#определение-новых-диапазонных-типов)

        8.  [Индексация 142](#_bookmark131)

        9.  [Ограничения для диапазонов 143](#ограничения-для-диапазонов)

    18. [Типы доменов 143](#типы-доменов)

    19. [Идентификаторы объектов 144](#идентификаторы-объектов)

    20. [Тип pg_lsn 148](#тип-pg_lsn)

    21. [Псевдотипы 149](#псевдотипы)

[Перечень сокращений 151](#перечень-сокращений)
...
> Для подключения к СУБД «Jatoba» необходимо выполнить следующие действия: а) запустить командую строку «cmd»;

б) в открывшемся окне командной строки перейти в каталог с местонахождением psql, при помощи команды:

<img src="../docs/assets/images/com18.3.1/user_guide/media/image3.png" style="width:7.03665in;height:0.75469in" />

cd ″C:\Program Files\GIS\Jatoba\4\bin\\

> Рисунок 2.1 – Переход в каталог в) ввести команду для подключения к СУБД:

psql -U \<учетная запись пользователя в СУБД\> -d \<наименование БД, к которой нужно произвести подключение\>

<img src="../docs/assets/images/com18.3.1/user_guide/media/image4.png" style="width:7.03647in;height:0.51031in" />
...
<img src="../docs/assets/images/com18.3.1/user_guide/media/image5.png" style="width:7.05485in;height:0.58219in" />

> Рисунок 2.3 – Ввод пароля

д) после ввода пароля необходимо нажать на клавишу «Enter».

> <img src="../docs/assets/images/com18.3.1/user_guide/media/image6.png" style="width:7.0367in;height:1.63875in" />
>
> Рисунок 2.4 – Подключение к базе данных

## Порядок подключения к СУБД «Jatoba» под управлением ОС GNU/Linux

> Для подключения к СУБД «Jatoba» необходимо выполнить следующие действия: а) запустить «Терминал»;
>
> б) выполнить вход в систему под пользователем СУБД (в ходе установки СУБД

по умолчанию создается пользователь «postgres»):

<img src="../docs/assets/images/com18.3.1/user_guide/media/image7.png" style="width:7.11821in;height:0.93969in" />
...
<img src="../docs/assets/images/com18.3.1/user_guide/media/image8.png" style="width:7.11575in;height:0.92031in" />
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image9.png" style="width:7.11575in;height:0.93in" />
>
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> Команде «UPDATE» необходимо, чтобы компонент «SET» всегда стоял в определенном положении, а «INSERT» требует наличие компонента
>
> «VALUES».
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image1.png" style="width:0.25139in;height:0.25139in" />Знаки доллара нельзя использовать в идентификаторах, так как их использование вредит переносимости приложений.
...
>
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.24896in" /> Используется неформальное соглашение записывать ключевые слова заглавными буквами, а имена строчными:
>
> UPDATE my_table SET a = 5

− в кавычках (отделенные идентификаторы) – образуются при заключении набора символов в двойные кавычки (").

<img src="../docs/assets/images/com18.3.1/user_guide/media/image1.png" style="width:0.25138in;height:0.25084in" /> Идентификаторы в кавычках не являются ключевыми словами.

> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> «select» можно использовать для обозначения столбца или таблицы «select», но
>
> select без кавычек будет воспринято системой как ключевое слово, что приведет к ошибке.
>
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image1.png" style="width:0.25138in;height:0.25117in" />При этом возникает неоднозначность с оператором &. Для того, чтобы ее избежать, необходимо окружить этот оператор пробелами.
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image1.png" style="width:0.25138in;height:0.25067in" />Это не то же самое, что двойная кавычка (").
...
1.  **Строковые константы со спецпоследовательностями в стиле C**
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.25in" />Если константа со спецпоследовательностью разбивается на несколько строк, букву E нужно поставить только перед первым открывающим апострофом.
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image1.png" style="width:0.25138in;height:0.25079in" />При параметре конфигурации standard_conforming_strings = off, PostgreSQL распознает обратную косую черту как спецсимвол и в обычных строках, и в строках со спецпоследовательностями.
>
...
2.  **Строковые константы со спецпоследовательностями Unicode**
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.25in" />Во избежание неоднозначности с оператором &, необходимо окружить этот оператор пробелами.
...
В качестве спецсимвола можно выбрать любой символ, кроме шестнадцатеричной

цифры, знака плюс, апострофа, кавычки или пробельного символа.

> Чтобы включить спецсимвол в строку буквально, необходимо написать его дважды.
>
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.24852in" />Спецпоследовательности Unicode в строковых константах работают только когда параметр конфигурации standard_conforming_strings = on.
>
> При standard_conforming_strings = off спецпоследовательности будут вызывать ошибку.

1.  **Строковые константы, заключенные в доллары**
...
> \[цифры\].цифры\[e\[+-\]цифры\] цифрыe\[+-\]цифры
...
\$1.столбец (функция_кортеж(a,b)).стол3
...
> Существуют два возможных синтаксиса применения операторов: выражение оператор выражение (бинарный инфиксный оператор) оператор выражение (унарный префиксный оператор)
...
- используются сортирующие агрегатные функции, которые будут описаны ниже. агрегатная_функция – имя ранее определенной агрегатной функции (возможно,

агрегатная_функция ( \[ выражение \[ , ... \] \] ) WITHIN GROUP ( предложение_order_by ) \[ FILTER ( WHERE условие_фильтра ) \]

дополненное именем схемы),
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.25in" />При использовании агрегатных функций с несколькими аргументами, предложение ORDER BY идет после всех аргументов.
>
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.25in" />Если же предложение_order_by находится не в WITHIN GROUP, оно не передается как аргумент(ы) агрегатной функции.
...
смещение PRECEDING CURRENT ROW

смещение FOLLOWING UNBOUNDED FOLLOWING
...
«неотрицательным», будет зависит от типа данных.

> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.24899in" />В режимах ROWS и GROUPS указания 0 PRECEDING и 0 FOLLOWING равнозначны указанию CURRENT ROW. Обычно это справедливо и для режима RANGE, в случае подходящего для типа данных определения значения «нуля».
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.24981in" />Приведение типа, представленное в виде вызова функции, на самом деле соответствует внутреннему механизму. Даже при использовании двух стандартных типов записи внутри происходит вызов зарегистрированной функции, выполняющей преобразование. По соглашению именем такой функции преобразования является имя выходного типа, и таким образом запись
>
> «в виде вызова функции» есть не что иное, как прямой вызов нижележащей функции преобразования.
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.25in" />Но если в результате выполнения подзапрос не вернет строк, скалярный результат считается равным NULL.
...
<tr>
<th colspan="3"><blockquote>
<p>SELECT ARRAY(SELECT oid FROM pg_proc WHERE proname LIKE 'bytea%');</p>
<p>array</p>
<p>{2011,1954,1948,1952,1951,1244,1950,2005,1949,1953,2006,31,2412</p>
<p>}</p>
<p>(1 row)</p>
<p>SELECT ARRAY(SELECT ARRAY[i, i*2] FROM generate_series(1,5) AS a(i));</p>
</blockquote></th>
</tr>
</thead>
<tbody>
...
<tr>
<th colspan="3"><blockquote>
<p>CREATE TABLE mytable(f1 int, f2 float, f3 text);</p>
<p>CREATE FUNCTION getf1(mytable) RETURNS int AS 'SELECT $1.f1' LANGUAGE SQL;</p>
</blockquote></th>
</tr>
</thead>
<tbody>
...
> SELECT getf1(ROW(1,2.5,'this is a test')); getf1
>
> 1
>
> (1 row)
...
> SELECT getf1(ROW(1,2.5,'this is a test')); ОШИБКА: функция getf1(record) не уникальна
>
...
передаче аргументы сопоставляются с параметрами функции по именам и указывать их можно в любом порядке.
...
> WHEN \$3 THEN UPPER(\$1 \|\| ' ' \|\| \$2) ELSE LOWER(\$1 \|\| ' ' \|\| \$2)
>
> END;
>
> \$\$
...
> SELECT concat_lower_or_upper('Hello', 'World', true); concat_lower_or_upper
>
> HELLO WORLD
>
> (1 row)
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.25in" /> В стандарте SQL описаны следующие типы (или их имена): bigint, bit, bit varying, boolean, char, character varying, character, varchar, date, double precision,
>
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.24897in" />В большинстве реализаций «не число» (NaN) считается не равным любому другому значению (в том числе и самому NaN). Чтобы значения numeric можно было сортировать и использовать в древовидных индексах, PostgreSQL считает, что значения NaN равны друг другу и при этом больше любых числовых значений (не NaN).
>
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.24999in;height:0.24945in" />Преобразование в кратчайший точный вид производится гораздо быстрее, чем в традиционное представление с округлением.
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.24999in;height:0.24854in" />Приложения, которым были нужны точные числовые значения, раньше задавали для параметра extra_float_digits значение 3, чтобы получить их. Они могут продолжать использовать это значение для максимальной совместимости с разными версиями.
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.2485in" />Согласно IEEE 754, NaN не должно считаться равным любому другому значению с плавающей точкой (в том числе и самому NaN). Чтобы значения с плавающей точкой можно было сортировать и использовать в древовидных индексах, PostgreSQL считает, что значения NaN равны друг другу, и при этом больше любых числовых значений (не NaN).
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.24902in" />В этом разделе описывается специфичный для PostgreSQL способ создания столбца с автоувеличением. Другой способ, соответствующий стандарту SQL, заключается в использовании столбцов идентификации и рассматривается в описании CREATE TABLE.
...
>
> SELECT 'abc \153\154\155 \052\251\124'::bytea; bytea
>
> abc klm \*\251T
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.25in" />Стандарт SQL требует, чтобы тип timestamp подразумевал timestamp without time zone (время без часового пояса), и PostgreSQL следует этому. Для краткости timestamp with time zone можно записать как timestamptz; это расширение PostgreSQL.
...
Для получения текущей даты/времени соответствующего типа можно также использовать следующие SQL-совместимые функции: CURRENT_DATE, CURRENT_TIME, CURRENT_TIMESTAMP, LOCALTIME и LOCALTIMESTAMP. Во

входных строках эти SQL-функции не распознаются.
...
<thead>
<tr>
<th><img src="../docs/assets/images/com18.3.1/user_guide/media/image1.png" style="width:0.25208in;height:0.25208in" /></th>
<th><blockquote>
<p>Входные значения now, today, tomorrow и yesterday вполне корректно работают</p>
<p>в интерактивных SQL-командах, но, когда команды сохраняются для</p>
</blockquote></th>
</tr>
</thead>
<tbody>
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.25in" />ISO 8601 указывает, что дата должна отделяться от времени буквой T в верхнем регистре. PostgreSQL принимает этот формат при вводе, но при выводе вставляет вместо T пробел, как показано выше. Это сделано для улучшения читаемости и для совместимости с RFC 3339 и другими СУБД.
...
<tr>
<th><blockquote>
<p><strong>Параметр datestyle</strong></p>
</blockquote></th>
<th><blockquote>
<p><strong>Порядок при вводе</strong></p>
</blockquote></th>
<th><blockquote>
...
<tr>
<td>SQL, DMY</td>
<td><em><strong>день</strong></em>/<em><strong>месяц</strong></em>/<em><strong>год</strong></em></td>
...
Ни названия, ни аббревиатуры часовых поясов, не зашиты в самом сервере; они считываются из файлов конфигурации, находящихся в путях .../share/timezone/ и

.../share/timezonesets/ относительно каталога установки.
...
> Интервалы можно также записывать в виде, определенном в ISO 8601, либо в

«формате с кодами», в разделе 4.4.3.2 этого стандарта, либо в «альтернативном формате», описанном в разделе 4.4.3.3. Формат с кодами выглядит так:
...
> SELECT EXTRACT(hours from '80 minutes'::interval); date_part
>
> 1
>
> SELECT EXTRACT(days from '80 hours'::interval); date_part
>
> 0
...
> Вывод в стиле iso_8601 соответствует «формату с кодами» описанному в разделе

4.4.3.2 формата ISO 8601.
...
>
> INSERT INTO holidays(num_weeks,happiness) VALUES (2, 'sad'); ОШИБКА: неверное значение для перечисления happiness: "sad" SELECT person.name, holidays.num_weeks FROM person, holidays
>
> WHERE person.current_mood = holidays.happiness; ОШИБКА: оператор не существует: mood = happiness
...
<tr>
<th colspan="3"><blockquote>
<p>SELECT person.name, holidays.num_weeks FROM person, holidays WHERE person.current_mood::text = holidays.happiness::text;</p>
<p>name | num_weeks</p>
</blockquote></th>
</tr>
</thead>
...
> Прямые представляются линейным уравнением Ax + By + C = 0, где A и B не равны

0\. Значения типа line вводятся и выводятся в следующем виде:
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.25in" />Если не устраивает выходной формат значений inet или cidr, попробуйте функции host, text и abbrev.
...
> '08:00:2b:01:02:03'
>
> '08-00-2b-01-02-03' '08002b:010203' '08002b-010203'
>
> '0800.2b01.0203' '0800-2b01-0203' '08002b010203'
...
>
> '08-00-2b-01-02-03-04-05' '08002b:0102030405'
>
> '08002b-0102030405' '0800.2b01.0203.0405' '0800-2b01-0203-0405' '08002b01:02030405' '08002b0102030405'
...
<thead>
<tr>
<th><img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25237in;height:0.25208in" /></th>
<th><blockquote>
<p>При попытке привести значение битовой строки к типу bit(n), оно будет усечено</p>
<p>или дополнено нулями справа до длины ровно n бит, ошибки при этом не будет.</p>
</blockquote></th>
</tr>
</thead>
<tbody>
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image1.png" style="width:0.25139in;height:0.25139in" />Некоторые XML-функции способны работать исключительно с ASCII-данными, если кодировка сервера не UTF-8. В частности, это известная особенность функций xmltable() и xpath().
...
> RFC 7159 разрешает включать в строки JSON спецпоследовательности Unicode в виде
...
<tr>
<th colspan="3"><blockquote>
<p>SELECT '[1, 2, 3]'::jsonb @&gt; '[3, 1]'::jsonb;</p>
</blockquote></th>
</tr>
</thead>
<tbody>
...
> -- Как и вхождение, существование определяется на верхнем уровне (команда выдает

false):

SELECT '{"foo": {"bar": "baz"}}'::jsonb ? 'bar';

> -- Строка считается существующей, если она соответствует примитивной строке
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.25in" />Так как вхождение в JSON проверяется с учетом вложенности, правильно написанный запрос может заменить явную выборку внутренних объектов. Предположим, что есть столбец doc, содержащий объекты на верхнем уровне, и большинство этих объектов содержит поля tags с массивами вложенных объектов. Данный запрос найдет записи, в которых вложенные объекты содержат ключи "term":"paris" и "term":"food", и при этом пропустит такие ключи, находящиеся вне массива tags:
...
Для эффективного поиска ключей или пар ключ/значение в большом количестве документов jsonb можно успешно применять индексы GIN. Для этого предоставляются два

«класса операторов» GIN, предлагающие выбор между производительностью и гибкостью.
...
"guid": "9c36adc1-7fb5-4d5b-83b4-90356a46061a", "name": "Angela Barton",

"is_active": true, "company": "Magnafone",

"address": "178 Howard Place, Gulf, Washington, 702", "registered": "2009-11-07T08:53:22 +08:00",

"latitude": 19.793713,

"longitude": 86.513373, "tags": \[
...
Индекс GIN извлекает из jsonpath конструкции следующего вида: цепочка_обращения = константа. Цепочка обращения может включать указания обращения

.ключ, \[\*\] и \[индекс\]. Класс операторов jsonb_ops дополнительно поддерживает указания .\* и .\*\*.
...
<tr>
<th colspan="3"><blockquote>
<p>SELECT array_dims(schedule) FROM sal_emp WHERE name = 'Carol';</p>
</blockquote></th>
</tr>
</thead>
<tbody>
...
> generate_subscripts(pay_by_quarter, 1) AS s FROM sal_emp) AS foo
...
<th colspan="3"><blockquote>
<p>SELECT</p>
<p>array_position(ARRAY['sun','mon','tue','wed','thu','fri','sat']</p>
<p>, 'mon'); array_position</p>
<p>2</p>
<p>(1 row)</p>
</blockquote></th>
</tr>
...
По умолчанию нижняя граница всех размерностей массива равна одному. Чтобы представить массивы с другими нижними границами, перед содержимым массива можно

указать диапазоны индексов. Такое оформление массива будет содержать квадратные скобки (\[\]) вокруг нижней и верхней границ каждой размерности с двоеточием (:) между ними. За таким указанием размерности следует знак равно (=).
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.25in" />Записывать значения массивов в командах SQL часто бывает удобнее с помощью конструктора ARRAY. В ARRAY отдельные значения элементов записываются так же, как если бы они не были членами массива.
...
integer REFERENCES suppliers, numeric CHECK (price \> 0)
...
<thead>
<tr>
<th><img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.24741in;height:0.24635in" /></th>
<th style="text-align: left;"><blockquote>
<p>PostgreSQL осуществляет развертывание столбцов фактически переводя первую форму во вторую. Таким образом, в данном примере myfunc() будет вызываться три раза для каждой строки и с одним, и с другим синтаксисом. Если</p>
<p>это дорогостоящая функция, можно использовать такой запрос:</p>
</blockquote></th>
</tr>
</thead>
<tbody>
...
Функция вывода составного значения заключает значения полей в кавычки, если они представляют собой пустые строки, либо содержат скобки, запятые, кавычки или обратную

косую черту, либо состоят из одних пробелов. Кавычки и обратная косая черта, заключенные в значения полей, при выводе дублируются.

> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.25in" />Помните, что написанная SQL-команда прежде всего интерпретируется как текстовая строка, а затем как составное значение. Вследствие этого число символов обратной косой черты удваивается (если используются спецпоследовательности). Чтобы ввести в поле составного столбца значение типа text с обратной косой чертой и кавычками, команду нужно будет записать так:
...
Нижнюю границу диапазона можно опустить и определить тем самым диапазон, включающий все значения, лежащие ниже верхней границы, например: (,3\]. Подобным

образом, если не определить верхнюю границу, в диапазон войдут все значения, лежащие выше нижней границы. Если же опущена и нижняя, и верхняя границы, такой диапазон будет включать все возможные значения своего подтипа. Указание отсутствующей границы как включаемой в диапазон автоматически преобразуется в исключающее; например, \[,\] преобразуется в (,). Можно воспринимать отсутствующие значения как плюс/минус бесконечность, но все же это особые значения диапазонного типа, которые охватывают и возможные для подтипа значения плюс/минус бесконечность.
...
> <img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.25in;height:0.24852in" />Эти правила очень похожи на правила записи значений для полей составных типов.
...
Определяя собственный диапазонный тип, можно выбрать другие правила

сортировки или класс оператора B-дерева для его подтипа, что позволит изменить порядок значений, от которого зависит, какие значения попадают в заданный диапазон.
...
<tr>
<th colspan="3"><blockquote>
<p>CREATE FUNCTION time_subtype_diff(x time, y time) RETURNS float8 AS</p>
<p>'SELECT EXTRACT(EPOCH FROM (x - y))' LANGUAGE sql STRICT IMMUTABLE;</p>
</blockquote></th>
</tr>
</thead>
<tbody>
...
Тогда как для скалярных значений естественным ограничением является UNIQUE, оно обычно не подходит для диапазонных типов. Вместо этого чаще оказываются полезнее ограничения-исключения. Такие ограничения позволяют определить условие

«непересечения» диапазонов.
...
ПОДРОБНОСТИ: Ключ (during)=(\["2010-01-01 14:45:00","2010-01-01

15:45:00")) конфликтует с существующим ключом (during)=(\["2010-01-01 11:30:00","2010-01-01 15:00:00"))
...
> Можно создать домен поверх целых чисел, принимающий только положительные

числа:

CREATE DOMAIN posint AS integer CHECK (VALUE \> 0); CREATE TABLE mytable (id posint);

INSERT INTO mytable VALUES(1); -- работает INSERT INTO mytable VALUES(-1); -- ошибка
...
<thead>
<tr>
<th><img src="../docs/assets/images/com18.3.1/user_guide/media/image2.png" style="width:0.24742in;height:0.24635in" /></th>
<th style="text-align: left;"><blockquote>
<p>Когда аргумент такой функции записывается как текстовая строка в чистом виде, она становится константой типа regclass. Так как фактически это будет просто значение OID, оно будет привязано к изначально идентифицированной последовательности, несмотря на то, что она может быть переименована, перенесена в другую схему и т. д. Такое «раннее связывание» обычно желательно для ссылок на последовательности в значениях столбцов по</p>
<p>умолчанию и представлениях. Но иногда возникает необходимость в «позднем</p>
</blockquote></th>
</tr>
</thead>
<tbody>
...
LSN должен находиться в допустимом для типа pg_lsn диапазоне, то есть между 0/0 и FFFFFFFF/FFFFFFFF.
...
<td><blockquote>
<p>Classless Internet Domain Routing</p>
</blockquote></td>
</tr>
<tr>
<td>DDL</td>
...
<td><blockquote>
<p>Universal Coordinated Time</p>
</blockquote></td>
</tr>
<tr>
<td>XML</td>
