---
title: 18.1. Building with Visual C++ or the Microsoft Windows SDK
---
...
[18.1.1. Requirements](</III. Server Administration/18. Installation from Source Code on Windows/install-windows-full.md#1811-requirements>)


[18.1.2. Special Considerations for 64-Bit Windows](</III. Server Administration/18. Installation from Source Code on Windows/install-windows-full.md#1812-special-considerations-for-64-bit-windows>)


[18.1.3. Building](</III. Server Administration/18. Installation from Source Code on Windows/install-windows-full.md#1813-building>)


[18.1.4. Cleaning and Installing](</III. Server Administration/18. Installation from Source Code on Windows/install-windows-full.md#1814-cleaning-and-installing>)


[18.1.5. Running the Regression Tests](</III. Server Administration/18. Installation from Source Code on Windows/install-windows-full.md#1815-running-the-regression-tests>)
...
For more information about the regression tests, see [Chapter 33](</III. Server Administration/33. Regression Tests/33. Regression Tests.md>).
