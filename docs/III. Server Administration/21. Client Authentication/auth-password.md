---
title: 21.5. Password Authentication
---
...
The `md5` method cannot be used with the [db_user_namespace](runtime-config-connection.html#GUC-DB-USER-NAMESPACE) feature.
