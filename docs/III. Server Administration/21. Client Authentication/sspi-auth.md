---
title: 21.7. SSPI Authentication
---
...
When using Kerberos authentication, SSPI works the same way GSSAPI does; see [Section 21.6](</III. Server Administration/21. Client Authentication/gssapi-auth.md>) for details.
