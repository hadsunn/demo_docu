---
title: 20.9. Run-time Statistics
---
...
These parameters control the server-wide cumulative statistics system. When enabled, the data that is collected can be accessed via the `pg_stat` and `pg_statio` family of system views. Refer to [Chapter 28](</III. Server Administration/28. Monitoring Database Activity/28. Monitoring Database Activity.md>) for more information.
