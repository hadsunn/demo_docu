...
PostgreSQL does not offer this type of replication, though PostgreSQL two-phase commit ([PREPARE TRANSACTION](</VI. Reference/I. SQL Commands/sql-prepare-transaction.md>)) can be used to implement this in application code or middleware.
