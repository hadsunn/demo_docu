...
Once the group role exists, you can add and remove members using the [`GRANT`](</VI. Reference/I. SQL Commands/sql-grant.md>) commands:
...
To destroy a group role, use [`DROP ROLE`](</VI. Reference/I. SQL Commands/sql-droprole.md>):
