---
title: Компонент «ja_Similar»

---

# Компонент «ja_Similar». Полнотекстовый поиск и определение похожих текстов.
...
Описание функции приведено в таблице Таблица 3.1.
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/ja_similar/media/image3.png)
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/ja_similar/media/image4.png)
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/ja_similar/media/image5.png)
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/ja_similar/media/image6.png)

Рисунок 3.4 – Отключение сканирования SeqScan

- Задать произвольный текст;

Задать произвольный текст для создания читаемого запроса, который будет искаться. Для примера взят фрагмент из статьи про Аристотеля.
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/ja_similar/media/image7.png)
...
![](@site/docs/assets/images/cert6.8.4,5.12.4,4.17.4/ja_similar/media/image8.png)
